...
<form action="./saleunit_new/appoint/guangzhou/updateContractCustomer.action" method="post" id="contractCustomerFormId">
	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="gbox" style="font-size:12px; line-height:26px">	
	  ...
	  <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
		style="empty-cells:show">
		<td style="width:15%" align="right"><font color="#FF0000">*</font>户籍&nbsp;</td>
		<td>
			<input type="text" id="householdProvince" name="customer.householdProvince" value="${customer.householdProvince}" disabled="disabled"/>
			<input type="text" id="householdCity" name="customer.householdCity" value="${customer.householdCity}" disabled="disabled"/>
			<input type="text" id="householdRegion" name="customer.householdRegion" value="${customer.householdRegion}" disabled="disabled"/>
			<input type="text" id="householdContent"  name="customer.householdContent" style="width:95%; height:20px" value="${customer.householdContent}" disabled="disabled"/>
		</td>		
	  </tr>	 
	  
	  <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
		style="empty-cells:show">
		<td style="width:15%" align="right"><font color="#FF0000">*</font>居住区域&nbsp;</td>
		<td>
			<input type="text" id="homeProvince" name="customer.homeProvince" value="${customer.homeProvince}" disabled="disabled"/>
			<input type="text" id="homeCity" name="customer.homeCity" value="${customer.homeCity}" disabled="disabled"/>
			<input type="text" id="homeRegion" name="customer.homeRegion" value="${customer.homeRegion}" disabled="disabled"/>
			<input type="text" id="homeContent" name="customer.homeContent"  style="width:95%; height:20px" value="${customer.homeContent}" disabled="disabled"/>
		</td>		
	  </tr>	 
	  
	  <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
		style="empty-cells:show">
		<td style="width:15%" align="right">工作区域&nbsp;</td>
		<td>
			<input type="text" id="workProvince" name="customer.workProvince" value="${customer.workProvince}" disabled="disabled"/>
			<input type="text" id="workCity" name="customer.workCity" value="${customer.workCity}" disabled="disabled"/>
			<input type="text" id="workRegion" name="customer.workRegion" value="${customer.workRegion}" disabled="disabled"/>
			<input type="text" id="workContent" name="customer.workContent" style="width:95%; height:20px" value="${customer.workContent}" disabled="disabled"/>
		</td>		
	  </tr>	 
