...
<%--主体导航页头 --%>
<div class="title02" ><a href="./report/guangzhou/appoint.action" target="_self">公司预约单</a></div>
<div class="title01" ><a href="./report/guangzhou/appointProperty.action" target="_self">楼盘预约单</a></div>
...
<%--主体table top --%>
     ...
     <form class="registerform" id="searchForm" action="<%=request.getContextPath() %>/report/guangzhou/appoint.action" method="post" >
		  <tr>
		  	<td colspan="6">
		 ...
		 <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="gbox" style="white-space:nowrap">
  			...
  			<tr onMouseOver="this.style.backgroundColor='#f1f9fe';" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF">
				...
				<td align="center" valign="middle" width="180">预约日期</td>
            ...
            <tr>
			  ...
			  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="gbox" >
				...
				<tr class="gboxbg">
					...
					<td width="197"  align="center">预约数量</td>
					<td width="197"  align="center">应收预约金</td>
					<td width="197"  align="center">实收预约金</td>
					
				</tr>
				
				 <s:iterator value="#request.appointReportList" id="c">  
				  
					<tr onMouseOver="this.style.backgroundColor='#f1f9fe';" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF">
						<td width="197" align="center" valign="middle" class="fontblue">
							<a href="./report/guangzhou/appointProperty.action?cond.propertyId=${c.pId}&cond.date1=${cond.date1}&cond.date2=${cond.date2}" target="_self">${c.propertyName}</a>
						</td>
						<td width="197"  align="center">${c.cou}</td>
						<td width="197"  align="center">${c.appMoney}</td>
						<td width="197"  align="center">${c.realMoney}</td>
					</tr>				
