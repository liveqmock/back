	  ...
	  <form class="registerform" action="./saleunit/appointbilldetail/guangzhou/updateAppointBillDetail.action" method="post" >	
		 ...
		 <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="gbox" >
		 	...
		 	<tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
                ...
                <td id="t16" colspan="4">
					&nbsp;&nbsp;<font color="#000000">修改实收款项明细(客户名称:${appoint.customerName})</font>
				</td>
              ...
              <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
                ...
                <td id="t16" style="width:30%">
				 <input type="text" id="payType" name="detail.payType" class="leftcreateinputbox01" value="${detail.payType}"/>
			    </td>
             ...
             <tr onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF";>
                ...
                <td id="t12">
				 	<input type="text" id="payMoney" name="detail.payMoney" class="leftcreateinputbox01" value="${detail.payMoney}"/>
				</td>
				
				 <td id="t11"  align="right">支付方式&nbsp;</td>
                <td id="t12">	
					<input type="text" id="payWay" name="detail.payWay" class="leftcreateinputbox01" value="${detail.payWay}"/>
				</td>
			  ...
			  <tr onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF";>
                ...
                <td id="t12">	
					<input type="text" id="bankWay" name="detail.bankWay" class="leftcreateinputbox01" value="${detail.bankWay}"/>
				</td>
			   ...
			   <tr onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF"; align="center">
				<td colspan="4">
				  ...
				  <input type="submit" value="  保存  " id="billSub"/>				 
					&nbsp;&nbsp;
				  <input type="button" value="  取消  " onclick="billDetailRet('${detail.billId}')"/>
