	...
	<head>
		...
		<script language="javascript" type="text/javascript">
			$().ready(function(){
				...
				$("#saleMonitor_companyId").change(function(){
					companyToProject(this.value, "saleMonitor_projectId");
				});
  ...
  <tr>
    ...
    <td width="100%" valign="top" height="100%" style="overflow:hidden;">
      ...
      <div class="titlel"></div>
		...
		<!-- right form top -->
		<form class="registerform" id ="registerform" action="./sale_hengda/input/saleForAdmin.action" method="post" >	
          ...
          <div class="c" >
             &nbsp;&nbsp;
				...
				<s:select list="selCompany" name="saleMonitor.companyId" value="#session.companyId" />
				<label>
					<span>所属项目</span>
				</label>
				<s:select list="selProject" name="saleMonitor.projectId" value="#session.projectId" />
           ...
           <table width="750" border="0" align="left" cellpadding="0" cellspacing="1" class="gbox"  style="margin-top:10px;_margin-top:0px;*margin-top:0px;">
			...
			<td width="78" align="center" id="t15"  >日期</td>
			   ...
			   &nbsp;<input type="text" class="Wdate" onClick="WdatePicker()"  id="monitorDate" 
			   	name="saleMonitor.monitorDate" value="${now}" style="width:90px"  title="只能录入当天数据"/>				
					</td>
				<td id="t7" align="center">当前时间</td>
                <td id="t15" nowrap="nowrap" >&nbsp;<font size="3" color="#FF0000" id="nowTime"></font>
				</td>
			</tr>
		   	<tr onMouseOver="this.style.backgroundColor='#ffffbf'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF";>
