...
<head>
	...
	<script type="text/javascript" language="javascript" src="./js/saleunit_contract_customer.js?v=1.3"></script><!-- 合同客户弹出框 -->
	...
	<script type="text/javascript" language="javascript">
		$().ready(function(){
			...
			initContractCustomerDataGrid("salesId", "${unit.id}", "${confirmType}", "customerId", "customer_table", "${confirmBook.id}");
...
<form action="./saleunit_new/appoint/guangzhou/updateConfirmBook.action" method="post" id="confirmBookFormId">
	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="gbox" style="font-size:12px; line-height:26px">	
			  ...
			  <tr bgcolor="#E9F5FF" style="empty-cells:show">
			   ...
			   <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
                ...
                <td id="t14" colspan="2">				 	
				  ...
				  <input type="text" id="salesName" class="readonly" readonly="readonly" style="width:85%" value="${confirmBook.salesName}"/>
				  <input type="hidden" id="salesId" name="confirmBook.salesId" value="${confirmBook.salesId}"/>
			  ...
			  <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" style="empty-cells:show">
			   ...
			   <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
                ...
                <td id="t16" style="width:30%">				 
					<input class="easyui-datebox" id="signDate" style="width:90px" 
					value='<s:date name="#request.confirmBook.createdTime" format="yyyy-MM-dd "/>' disabled="disabled"/>		
				 </td>
			...
			min="1" max="100"  required="false" style="width:43px;"></input>(%)
			   ...
			   <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
                ...
                <td id="t14" colspan="3">
					<input id="discountDesc" name="confirmBook.discountDesc" style="width:70%" value="${confirmBook.discountDesc}"/>
				</td>		
              </tr>	 
			   ...
			   <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
                ...
                <td id="t14" colspan="3">
					<input style="width:70%" id="renovateDesc" name="confirmBook.renovateDesc" value="${confirmBook.renovateDesc}"/>
				</td>		
              </tr>	 
			  ...
			  <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
                ...
                <td id="t16" style="width:30%">
				 <input class="easyui-datebox" id="endDate" name="confirmBook.endDate" style="width:90px"
				  ...
				  <input type="hidden" name="confirmBook.customerId" value="${confirmBook.customerId}" />	
				  <input type="hidden" name="confirmBook.confirmId" value="${confirmBook.confirmId}" />	
