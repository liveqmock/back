 ...
 * @author WINDY
 */
public class GetUserComputerInformationlUtils {
    ...
    public GetUserComputerInformationlUtils(String strAddr) throws Exception {
        sRemoteAddr = strAddr;
    ...
    public static void main(String[] args) throws Exception {
    	GetUserComputerInformationlUtils addr = new GetUserComputerInformationlUtils("172.16.6.22");
