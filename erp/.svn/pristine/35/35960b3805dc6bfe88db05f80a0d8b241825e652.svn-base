      ...
      <div class="titlel"></div>
        <div class="titlebg" style=" height:auto;overflow:hidden;">
         ...
         <div class="title01" ><a href="./customer_tianluan!searchCustomer.action?from=left" target="_self">查询客户</a></div>
          ...
          <div class="c"></div>
           <form action="<%=request.getContextPath() %>/updateUserAccount.action" method="post" id="commentForm">
 		 ...
 		 <tr>
    			<td></td><td><input type="submit" name="button" id="button" value="保 存" align="right" />
         </td>
  </tr>
