      ...
      <div class="titlel"></div>
        <div class="titlebg" style=" height:auto;overflow:hidden;">
          ...
          <div class="title01" ><a  href="./user_oldhuijing!indexUserAccount.action" target="_self">列表</a></div>
            <div class="title02"><a  href="./user_oldhuijing!addUserAccountJsp.action" target="_self">新建</a></div>
        
          <div class="c"></div>
           <form action="./user_oldhuijing!addUserAccount.action" method="post" id="commentForm">
