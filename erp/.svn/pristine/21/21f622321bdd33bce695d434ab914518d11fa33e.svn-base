...
<table width="100%" border="0" cellspacing="0">
    ...
    <div class="right05">
      <div class="titlel"></div>
        <div class="titlebg" style=" height:auto;overflow:hidden;">
	        ...
	        <div class="title02" ><a href="./userrole!queryUserRoles.action" target="_self">查询用户角色</a></div>
            <div class="title01"><a href="./userrole!doSomeForAddUserRole.action" target="_self">新建用户角色</a></div>			
       ...
       <form action="userrole!queryUserRoles.action" method="get">
			
            <tr>
			  <td width="9%" height="0" align="center"><label> <span>用户名称</span></label></td>
              <td width="17%" height="0" >
			  	&nbsp;<input type="text" id="userNameRemote" name="userRoleCond.userName" value="${userRoleCond.userName}"  style="width:180px"/>
			  </td>  
			
			  
			  <td width="74%" height="0" colspan="4">
		...
		<s:if test="#session.loginAccount.accountType == 2 ">
            ...
            <tr>
			  ...
			  操作
			  <input type="button" id="delete" value="  删除  " onClick="return delSome('userrole', 'deleteUserRoles')"/>
				 &nbsp;&nbsp;
  ...
  <tr class="gboxbg">
    ...
    <td width="317" align="center" valign="middle">用户名称</td>
    <td width="303" align="center" valign="middle">角色名称</td>	
    <td width="278" align="center" valign="middle">修改人</td>
    <td width="358" align="center" valign="middle">修改时间</td>	
	
    
  </tr>
  
  
   <s:iterator value="#request.userRoleList" id="r">  
	  <tr onMouseOver="this.style.backgroundColor='#f1f9fe';" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF"> 
		...
		<td align="center" valign="middle" class="fontblue">
			<a href="./userrole!queryUserRoleById.action?id=<s:property value='#r.id'/>" target="_self" ><s:property value="#r.descUserRealName"/></a>
			
		</td>
		<td align="center" valign="middle">
			<s:property value="#r.descRoleName"/>
		</td>
		<td align="center" valign="middle">
