 ...
 <DIV style="WIDTH: 98%; HEIGHT: 100%; BACKGROUND-COLOR: #A4C3D7;padding: 1px">
	<table width="100%" class="mainbg20111112" style="height: 100%">
		<tr>
		 ...
		 <form class="registerform" action="./saleunit/contract/guangzhou/updateContractService.action" method="post" >	
             ...
             <tr onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF";>
                ...
                <td id="t12">	
					 <input class="Wdate" type="text" id="promiseDoDate" style="width:90px" name="contractService.promiseDoDate" 
					  value='<s:date name="#request.contractService.promiseDoDate" format="yyyy-MM-dd "/>'/>
				</td>
                ...
                <td id="t12">
					 ...
					 value='<s:date name="#request.contractService.promiseFinishDate" format="yyyy-MM-dd "/>'/>		
				</td>
			   ...
			   <tr onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF"; align="center">
				<td colspan="4">
				  ...
				  <input type="hidden" name="contractService.id" value="${contractService.id}"/>	 
				</td>
			  </tr>
