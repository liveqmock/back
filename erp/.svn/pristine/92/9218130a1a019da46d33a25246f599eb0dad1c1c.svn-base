...
<form action="./saleunit/operation/submitCancelUnit.action" method="post" id="submitCancelUnitFormId">
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="gbox" style="font-size:12px; line-height:26px">	
			  ...
			  <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
			   ...
			   <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
                ...
                <td id="t16" style="width:30%">
					<s:if test="contract.priceWay == 1">建筑面积</s:if>
					<s:elseif test="contract.priceWay == 2">套内面积</s:elseif>					
				</td>			
              </tr>	 
			   ...
			   <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
				...
				<td id="t13" style="width:15%" align="right"><font color="#FF0000"></font>合同编号&nbsp;</td>
                <td id="t14">
				${contract.contractNo}</td>	
				
				<td id="t15" style="width:15%" align="right"><font color="#FF0000"></font>签约日期&nbsp;</td>
                <td id="t16" style="width:30%">	
				  <s:date name="#request.contract.workDate" format="yyyy-MM-dd" />
				 </td>						
              </tr>	 			   
			   ...
			   <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
                ...
                <td id="t16" style="width:30%">
                	<s:if test="contract.isSecondConfirm==1">
                		是
                	</s:if>
                	<s:else>
                		否
                ...
                <td id="t14">
                	<s:if test="contract.isSecondLinkage==1">
                		是
                	</s:if>
                	<s:else>
                		否
			   ...
			   <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
                ...
                <td id="t16" style="width:30%">
					<s:if test="contract.isRelation==1">
                		是
                	</s:if>
                	<s:else>
                		否
			  ...
			  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="gbox" style="font-size:12px; line-height:26px">
			  <span style="font-size:12px; line-height:26px">新建退房资料</span>
			<tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
			  	style="empty-cells:show">
				<td id="t15" style="width:15%" align="right">滞纳金&nbsp;</td>
                <td id="t16" colspan="3">
					<input type="text" id="overdueFine" name="cancelUnit.overdueFine"/>
				</td>
				<td id="t15" style="width:15%" align="right">退房日期&nbsp;</td>
                <td id="t16" colspan="3">
					<input class="easyui-datebox" type="text" id="cancelTime" style="width:90px" name="cancelUnit.cancelTime" value="${nowDate}"/>	</td>
                ...
                <td id="t16" colspan="3">
					<input type="text" id="approverMan" name="cancelUnit.approverMan"/>
				</td>
				<td id="t15" style="width:15%" align="right"><font color="red">*</font>经办人&nbsp;</td>
                <td id="t16" colspan="3">
					<input type="text" id="inputMan"  name="cancelUnit.inputMan"/>
				</td>
			  ...
			  <td id="t15" style="width:15%" align="right">备注&nbsp;</td>
                <td id="t16" colspan="3">
					<input type="text" id="remark" name="cancelUnit.remark"/>
				</td> 
				<td></td>
				<td colspan="3"></td>
			   </tr>
