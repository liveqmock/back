...
<div data-role="page" id="input_customer_succ_page">

	<div data-role="header" data-theme="b">
    	<a href="<%=basePath%>m/to.action?ts=<%=new Date()%>" data-icon="back" data-role="button">返回</a>
		<h1>保存成功,选择问卷</h1>        
	...
	<div data-role="content">
    	...
    	<form id="input_succ_form" action="<%=basePath%>m/toAddQuestion.action" method="get" data-ajax="false">
         ...
         <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" style="text-align:center">
          <tr>
                ...
                <td>                	
                    ...
                    <input type="hidden" name="projectId" value="${customer.projectId}" />
            ...
            <tr>
            	<td colspan="2">               
                     ...
                     <button type="submit" value="录入问卷" data-icon="check" data-theme="b"></button>
