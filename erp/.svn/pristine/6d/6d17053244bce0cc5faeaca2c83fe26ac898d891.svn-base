...
<table bgcolor="#ffffff" style="font-size: 12"  class="gbox" width="100%" align="center" cellspacing="1" cellpadding="0" border="0">
  <tr>
    <td style="font-weight: bold" width="18%">销售单1</td>
...
<form action="./saleunit/confirm/guangzhou/addForChangeUnit.action" method="post">
<table bgcolor="#ffffff" style="font-size: 12"  class="gbox" width="100%" align="center" cellspacing="1" cellpadding="0" border="0">
	<tr>
		<td  width="18%">房间</td>
	...
	<tr>
		...
		<td  colspan="3" align="left">
			...
			<input type="hidden" id="change_unit_unit_id2_hid" name="changeUnitForm.unitId2">
		</td>
	</tr>
...
<table bgcolor="#ffffff" style="font-size: 12"  class="gbox" width="100%" align="center" cellspacing="1" cellpadding="0" border="0">
  <tr>
		...
		<td   width="82%"  colspan="3" align="left">
			<input type="text" id="change_unit_hand_fee" name="changeUnitForm.handFee"/>
		</td>
	</tr>
	<tr>
		<td >变更原因</td>
		<td  colspan="3" align="left">
			<select id="change_unit_reson_type" name="changeUnitForm.resonType">
	...
	<tr>
		<td>原因说明</td>
		<td align="left">
			<input type="text" id="change_unit_reson_desc" name="changeUnitForm.resonDesc" style="width: 100%"/>
		</td>
	</tr>
	<tr>
