...
<table width="100%" border="0" cellspacing="0">
  <tr>
    ...
    <div class="right05">
      <div class="titlel"></div>
        <div class="titlebg" style=" height:auto;overflow:hidden;">
	        ...
	        <div class="title02" ><a href="./customer_shanshui!searchCustomer.action?from=left" target="_self">查询客户</a></div>
       ...
       <form action="customer_shanshui!searchCustomer.action" method="get">
		   <tr>
             ...
             <s:if test="#session.loginAccount.accountType == 2 ">
              ...
              <td width="469" height="0">
			  	<s:select list="#session.selUserForShanShui"  name="customerCond.userId" value="#session.customerCond.userId"/>				</td>
			 </s:if>
            </tr>		
		...
		<s:if test="#session.loginAccount.accountType == 2 ">
            ...
            <tr>
			  ...
			  操作&nbsp; 	
				<input type="button" id="delete" value="  删除  " onClick="return delCustomers('customer_shanshui')"/>&nbsp;&nbsp; <a href="customer_shanshui!downLoad.action"><font color="blue"> [导出]</font></a>
   ...
   <tr>
	...
	<table class="gbox" style="table-layout: fixed; width: 980px font-size: 12px; white-space: nowrap;"  align="center" border="0" cellpadding="0" cellspacing="1" width="100%">	
	...
	<table width="100" height="28"  border="0" align="center" cellspacing="0" >
      <tr>
        ...
        <td align="center" valign="middle"><table width="5" border="0" cellspacing="0">
          <tr>
            <td><a href="customer_shanshui!searchCustomer.action?ob=12"><img src="images/blue/upn.gif" width="9" height="10" border="0" /></a></td>
          </tr>
          <tr>
            <td><a href="customer_shanshui!searchCustomer.action?ob=11"><img src="images/blue/downopen.gif" width="9" height="10" border="0" /></a></td>
          </tr>
        </table>	</td>
      </tr>
    </table></td>
	...
	<table width="75" height="28" border="0" align="center" cellspacing="0">
      <tr>
		...
		<table width="5" border="0" cellspacing="0">
          <tr>
            <td><a href="customer_shanshui!searchCustomer.action?ob=14"><img src="images/blue/upn.gif" width="9" height="10" border="0" /></a></td>
          </tr>
          <tr>
            <td><a href="customer_shanshui!searchCustomer.action?ob=13"><img src="images/blue/downopen.gif" width="9" height="10" border="0" /></a></a></td>
          </tr>
        </table>	  </td>
      </tr>
      </table></td>
	  ...
	  <tr onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF"
	   title='客户名称:<s:property value="#c.customerName"/>, 电话:<s:property value="#c.phone"/>'> 
		...
		<td align="center" valign="middle" class="fontblue" >
			<a href="./customer_shanshui!queryCustomerById.action?id=<s:property value='#c.id'/>" target="_self" ><s:property value="#c.customerName"/></a>		</td>
