...
<head>
	...
	<script type="text/javascript" language="javascript">
		$().ready(function(){
			...
			var payTypeVal = "${confirmBook.payWayId}";
			if(payTypeVal != ""){
			
				payTypeAjax(payTypeVal);
			}
			...
			/**		
			$("#discountPercent").numberspinner({
			 	onSpinUp:function(){
					var value = $('#discountPercent').numberspinner("getValue");
					percentToMoney("${unit.sumPrice}", value);					
				},
		...
		//根据百分比获取对应金额的折扣价
		function percentToMoney(sumMoney, percent){
			
			if(!isNaN(sumMoney)){
				$("#sumMoney").val(parseInt(parseInt(sumMoney) * (percent/100)));
			}
			
		}
		
		function payTypeAjax(wayId){
...
<form action="./saleunit_new/appoint/guangzhou/updateTempConfirmDialog.action" method="post" id="tempConfirmFormId">
	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="gbox" style="font-size:12px; line-height:26px">		
              ...
              <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
			   ...
			   <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
                ...
                <td id="t14" colspan="3">		
				<input id="customerName" name="confirmCustomer.customerName" value="${confirmCustomer.customerName}" type="text" style="width:70%"/>		
				</td>			
              </tr>	 
			   ...
			   <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
                ...
                <td id="t14">
				<input type="text" id="phone" name="confirmBook.phone" value="${confirmBook.phone}" style="width:85%"/>
				</td>		
                <td id="t15" style="width:15%" align="right">客户证件号码&nbsp;</td>
                <td id="t16" style="width:30%">
				<input type="text" id="idcardNo" name="confirmCustomer.idcardNo" value="${confirmCustomer.idcardNo}" />
				</td>			
              </tr>	 
			   ...
			   <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
                ...
                <td id="t14" colspan="3">				
				<input type="text" id="address" name="confirmCustomer.address" style="width:70%" value="${confirmCustomer.address}" />
				</td>	
              </tr>	 
			   ...
			   <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
                ...
                <td id="t14" colspan="3">
					...
					优惠折扣<input name="confirmBook.discountPercent" id="discountPercent" class="easyui-numberspinner" value="${confirmBook.discountPercent}"
			min="1" max="100"  required="false" style="width:43px;"></input>(%)
					<!--,
			   ...
			   <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
				...
				<td id="t13" style="width:15%" align="right"></td>
                <td id="t14" colspan="3">
					折扣说明:<input id="discountDesc" name="confirmBook.discountDesc" style="width:70%" value="${confirmBook.discountDesc}"/>
				</td>		
              </tr>	 
			   ...
			   <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
				...
				<td id="t13" style="width:15%" align="right"></td>
                <td id="t14" colspan="3">
					装修标准:<input style="width:70%" id="renovateDesc" name="confirmBook.renovateDesc" value="${confirmBook.renovateDesc}"/>
				</td>		
              </tr>	 
			  ...
			  <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
                ...
                <td id="t14">
				￥<input type="text" class="money" id="bookMoney" name="confirmBook.bookMoney" value="${confirmBook.bookMoney}"/>元			
				</td>		
                <td id="t15" style="width:15%" align="right">失效日期&nbsp;</td>
                <td id="t16" style="width:30%">
				 <input class="Wdate" id="endDate" name="confirmBook.endDate" style="width:90px"
					  value='<s:date name="#request.confirmBook.endDate" format="yyyy-MM-dd "/>'/>
				  
				   <input type="hidden" id="baseUrl" value="<%=basePath%>"/>			
				  <input type="hidden" name="confirmBook.id" value="${confirmBook.id}" />
				  <input type="hidden" name="confirmBook.unitId" value="${confirmBook.unitId}" id="confirmBookUnitId"/>
				  <input type="hidden" name="confirmCustomer.confirmType" value="${confirmCustomer.confirmType}" />
				  <input type="hidden" name="confirmCustomer.id" value="${confirmCustomer.id}" />		
				  <input type="hidden" name="confirmCustomer.phone" value="${confirmCustomer.phone}" />		
				  <input type="hidden" name="confirmBook.customerId" value="${confirmCustomer.id}" />		
				</td>			
              </tr>	 
