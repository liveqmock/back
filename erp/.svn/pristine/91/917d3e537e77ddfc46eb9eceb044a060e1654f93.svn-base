...
<%--主体table top --%>
	  ...
	  <form class="registerform" action="./saleunit/confirm/guangzhou/updateConfirm.action" method="post" >	
		...
		<table style="width: 800px;" align="left" border="0" cellspacing="0">	
		  ...
		  <tr>
              ...
              <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
				...
				<a href="#" onclick="return false;" id="showConfirmCustomer">${confirm.customerName}</a>
				<input type='hidden' id='confirmCustomerId'  name="confirm.customerId" value="${confirm.customerId}"/>
			  ...
			  <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
			   ...
			   <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
                ...
                <td id="t16" style="width:30%">
					<input type="text" id="discountPercent" name="confirm.discountPercent" class="leftcreateinputbox01"  style="width:25%" value="${confirm.discountPercent}" />
				 </td>			
              </tr>	 
			   ...
			   <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
                ...
                <td id="t14">
				 <input type="text" id="buildPrice" name="confirm.buildPrice" class="leftcreateinputbox01" style="width:25%" value="${confirm.buildPrice}" />
				 元	
				</td>		
               <td id="t13" style="width:15%" align="right"><font color="#FF0000">*</font>套内成交单价&nbsp;</td>
                <td id="t14">
					 <input type="text" id="insideUnitPrice" name="confirm.insideUnitPrice" class="leftcreateinputbox01"  style="width:25%" value="${confirm.insideUnitPrice}" />
				 元
				</td>		
              </tr>	 
			   ...
			   <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
                ...
                <td id="t16" style="width:30%">
					 <input type="text" id="sumMoney" name="confirm.sumMoney" class="leftcreateinputbox01"  style="width:25%" value="${confirm.sumMoney}" />
				 元</td>			
              </tr>	 
			  ...
			  <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
                ...
                <td id="t14">
				 <input type="text" id="renovatePrice" name="confirm.renovatePrice" class="leftcreateinputbox01" value="${confirm.renovatePrice}" style="width:25%"/>
				元
				</td>				
              </tr>	
                ...
                <td id="t14">
				 <input type="text" id="renovateMoney" name="confirm.renovateMoney" class="leftcreateinputbox01" value="${confirm.renovateMoney}" style="width:25%"/>
				元
				</td>				
              </tr>	
			  ...
			  <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
                ...
                <td id="t16" style="width:30%">
				   <input type="text" id="shouldDeposit" name="confirm.shouldDeposit" class="leftcreateinputbox01"  style="width:25%" value="${confirm.shouldDeposit}" />
				 元</td>
                 <td id="t13" style="width:15%" align="right"><font color="#FF0000">*</font>协议总价&nbsp;</td>
                <td id="t14">
				  <input type="text" id="agreeMoney" name="confirm.agreeMoney" class="leftcreateinputbox01" style="width:25%" value="${confirm.agreeMoney}" />
				 元
				 </td>				
              </tr>	
			  ...
			  <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
			   ...
			   <tr onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF"; align="center">
				<td colspan="4">
				  ...
				  <input type="hidden" name="confirm.id"  value="${confirm.id}"/>
					&nbsp;&nbsp;
				  <input type="button" value="  取消  " onClick="javascript:window.location.href = '<%=basePath%>saleunit/confirm/guangzhou/searchList.action'" />
				  
				   <s:if test="confirm.canChangeToContract"> 
				    &nbsp;&nbsp;					
				   <input type="button" value="  转合同  " id="changeToContractButton" onclick="return changeToContract(${confirm.id})"/>
				   </s:if>
				</td>
			  </tr>			 
