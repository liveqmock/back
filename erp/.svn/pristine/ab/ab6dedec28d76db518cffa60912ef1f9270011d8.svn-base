	...
	*/%>
	...
	<script type="text/javascript" language="javascript">
		...
		$().ready(function(){
			...
			bindPayTypeByFee("typeName", "feeType");
...
<form action="./saleunit_financial_tabs/guangzhou/updateReceipt.action" method="post" id="updateReceiptFormId">
	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="gbox" style="font-size:12px; line-height:26px">		
		 ...
		 <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
		   ...
		   <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
                ...
                <td id="t16" style="width:30%">
					...
					*/%>
					...
					<pt:sel cssStyle="width:auto" id="feeType" name="receipt.feeType" typeName="" value="${receipt.feeType}"/>
				</td>			
            </tr>	 
		   ...
		   <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
			style="empty-cells:show">
			<td id="t13" style="width:15%" align="right"><font color="red">*</font>客户姓名&nbsp;</td>
			<td id="t14" style="width:25%">
