...
<%--主体table top --%>
	...
	<table style="width: 100%;" align="left" border="0" cellspacing="0">		  
     ...
     <form class="registerform" id="searchForm" action="<%=request.getContextPath() %>/saleunit/appoint/guangzhou/appointInputFirst.action" method="post" >
		  <tr>
		  	<td colspan="6">
   ...
   <s:iterator value="#request.buildList" id="c">  
	  <tr onMouseOver="this.style.backgroundColor='#f1f9fe';" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF"> 
		...
		<td align="center" valign="middle" class="fontblue">
			<a href="./saleunit/appoint/guangzhou/changeBuildToSecond.action?buildId=${c.id}">选择</a>
		</td>
