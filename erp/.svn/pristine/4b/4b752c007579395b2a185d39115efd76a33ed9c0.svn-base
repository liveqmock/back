    ...
    <div class="right05">
      <div class="titlel"></div>
        ...
        <div class="titlebg" style=" height:auto;overflow:hidden;">	
	  	...
	  	<form class="registerform" action="userrole!updateUserRole.action" method="get" >	

             <tr onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF";>
                <td width="36%" align="center" id="t13">用户名称</td>
                <td width="64%" id="t14">
					&nbsp;<input type="text" value="${session.userRole.descUserRealName}(${session.userRole.descUserName})" style="width:180px" disabled="disabled"/>
					<input type="hidden" name="userRole.userId" value="${session.userRole.userId}"/>
				</td>  
			   ...
			   <tr onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF";>
                ...
                <td width="64%" id="t14">
					&nbsp;<input type="text" id="roleName"  name="roleName" value="${session.userRole.descRoleName}(${session.userRole.roleId})" style="width:180px"/>
		  ...
		  <tr onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF"; align="center">
			<td colspan="4">
			  <input type="hidden" name="userRole.id" value="${session.userRole.id}"/>
