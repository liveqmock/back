...
<form action="./saleunit_new_init/appoint/guangzhou/customerBeforeModifyQuestionForm.action" id="question_form" method="post">	
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="gbox" style="font-size:12px; line-height:26px">
		<tr bgcolor="#ffffff">
			...
			<td>
				<input name="newQuestion.questionName" id="question_name" value="${newQuestion.questionName}"/>
			</td>
		</tr>
		<tr bgcolor="#ffffff">
	...
	<input type="hidden" id="newQuestionId" name="newQuestion.id" value="${newQuestion.id}"/>
