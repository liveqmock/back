...
<%--主体table top --%>
           ...
           <tr>
			...
			<tr>
			 ...
			 <tr>
			  ...
			  <input type="button" value="  新建个性装修  " onclick="inputContractRenovateDialog(${contract.id})"/>
              </td>
            </tr>
 ...
 <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="gbox" >
  <tr class="gboxbg">
    ...
    <td width="120" align="center" valign="middle">应收日期</td>   
	
    <td width="120" align="center" valign="middle">款项类型</td>
	
	<td width="120" align="center">款项名称</td>
   ...
   <s:iterator value="#request.contractRenovateList" id="c">  
	  <tr onMouseOver="this.style.backgroundColor='#f1f9fe';" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF"> 
		...
		<td align="center" valign="middle" class="fontblue" title="点击修改">
			<a href="#" onclick="return updateContractRenovateDialog(${c.id})"><s:date name="#c.payDate" format="yyyy-MM-dd "/></a>
