...
/**
 * Checkcommission的Services接口(业务接口)
 * @author 
 *
 */
@Transactional 
public interface ICheckcommissionServices {
    ...
    /**
     * 根据单元idList查找Checkcommission
     * @param maps
     * @return
     * @throws RuntimeException
     */
    public List<Map> findCheckcommissionByUnitIdList(Map<String,List> maps) throws RuntimeException; 
}