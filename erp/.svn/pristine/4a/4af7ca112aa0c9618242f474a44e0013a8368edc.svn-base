 ...
 *
 */ 
public interface IReportPreCustomerMapper {
	 ...
	 * @return
	 */
	public List<ReportPreCustomerCompany> groupByCompany(ReportPreCustomerCompanyCond cond) ;
	...
	public List<ReportPreCustomerCompanyDate> groupByCompanyDate(ReportPreCustomerCompanyDateCond cond);
