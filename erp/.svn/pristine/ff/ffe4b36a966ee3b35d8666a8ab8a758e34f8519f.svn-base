 ...
 *  周查询 action
 */
public class SearchWeekAction extends SupperAction{
	...
	private SaleMonitorAmount initSaleMonitorWeekAmount(SaleMonitorAmount saleMonitorAmount, List<SaleMonitor> saleList){
	...
	private SaleMonitorCond saleWeekCond;
	...
	public void setSaleWeekCond(SaleMonitorCond saleWeekCond) {
		this.saleWeekCond = saleWeekCond;
	}
	
	public SaleMonitorCond getSaleWeekCond() {
		return saleWeekCond;
	}
