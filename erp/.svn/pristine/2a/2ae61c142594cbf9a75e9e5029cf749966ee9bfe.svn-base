...
<div class="title02" ><a href="./report/guangzhou/propertySaleMonth.action" target="_self">月报</a></div>
...
<%--主体table top --%>
  ...
  <tr class="gboxbg">
    ...
    <td colspan="4" align="center">月成交统计(齐定)</td>
    <td  colspan="4" align="center">月签约统计</td>
    <td   colspan="2" align="center">月回款情况</td>
  </tr>
  <tr class="gboxbg">
