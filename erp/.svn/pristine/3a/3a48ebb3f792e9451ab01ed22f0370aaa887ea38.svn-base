...
<html>
	<head>
		...
		function queryForm(){
			...
			$.ajax({
				url: './saleunit_new_report/report/guangzhou/customerNumSalesAjax.action',
				dataType:'json',
				data: getInputsAsOjbect(["cond.strSearchCompanyProjectIds","cond.date1","cond.date2","selCycel"]),
		...
		$().ready(function(){
			...
			bindProjectDialogForSQKHOnly("projectNames", "projectIds");
		});
