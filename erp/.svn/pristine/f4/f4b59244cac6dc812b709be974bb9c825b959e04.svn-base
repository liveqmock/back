    ...
    <div class="right05">
      <div class="titlel"></div>
        ...
        <div class="title01"><a href="./userrole!doSomeForAddRole.action" target="_self">新建角色</a></div>	
	  	...
	  	<form class="registerform" action="userrole!updateRole.action" method="get" >	

             <tr onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF";>
                <td width="21%" align="center" id="t13">角色名称</td>
                <td width="30%" id="t14">
					&nbsp;<input type="text" name="role.roleName" id="addOrUpdateRoleName" class="leftcreateinputbox01" value="${session.role.roleName}"/>
				</td>  
				 <td width="20%" align="center" id="t13">所属项目</td>
                <td width="29%" id="t14">
					&nbsp;<input type="text" name="projectName" id="projectName" class="leftcreateinputbox01"  value="${session.projectName}"/>
				</td>
			   ...
			   <tr onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF";>
                ...
                <td id="t12" colspan="3">
					 &nbsp;<input type="text" name="role.roleDesc" id="roleDesc" class="leftcreateinputbox02" style="width:80%" value="${session.role.roleDesc}"/>
				</td>
