		 ...
		 <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="gbox" >
			  ...
			  <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
                ...
                <td id="t16">
					...
					<input type="hidden" id="hiddenId" name="appoint.propertyId" />
				...
				<td>
					...
					<input type="hidden" id="hiddenBulidId" name="buildId" />
				</td>
              ...
              <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
                ...
                <td id="t16" style="width:30%">
				 <input type="text" id="unitId" class="leftcreateinputbox01"/>
 				 <input type="hidden"  name="appoint.unitId" id="hiddenUnitId"/>
				 </td>
             ...
             <tr onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF";>
                ...
                <td id="t12" class="fontblue">
					...
					<input type='hidden' id='appointCustomerId' name="appoint.customerId"/>
					<a href="#" onclick="return false;" id="createAppointCustomer">新建客户</a>
				</td>
