...
<head>
	...
	<script type="text/javascript" language="javascript">
		$().ready(function(){
			...
			initContractCustomerDataGridNewRename("salesId", "${unit.id}", "1", "customerId", "customer_table", "${confirm.id}");
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="gbox" style="font-size:12px; line-height:26px">	
			...
			<td id="t20" style="width:25%">
				<input type="text" id="approverMan" name="customerRename.approverMan"/></td>					
			<td id="t21" style="width:15%" align="right"><font color="red">*</font>经办人&nbsp;</td>
			<td id="t22" style="width:25%">
				<input type="text" id="inputMan" name="customerRename.inputMan" style="width:width:25%"/></td>	
		  </tr>
		   ...
		   <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
			...
			<td id="t28" style="width:25%">
				<input class="easyui-datebox" type="text" id="customerRenameTime" style="width:90px" name="customerRename.renameTime" value="${nowDate}"/>
			<td id="t29" style="width:15%" align="right"><font color="red"></font>备注&nbsp;</td>
			<td id="t30" style="width:25%">
				<input type="text" id="remark" name="customerRename.remark" value=""/>				</td>					
		  </tr>
			  ...
			  <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
				...
				<td>
				  ...
				  <input type="hidden" id="hiddenPropertyProjectId" name="confirm.propertyProjectId" value="${confirm.propertyProjectId}"/>
				    <input type="hidden" id="oldCustomerId" name="oldCustomerId" />
				  </td>
			   ...
			   <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
                ...
                <td id="t16" style="width:30%">	
				  <s:date name="confirm.workDate" format="yyyy-MM-dd"></s:date>
			   ...
			   <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
                ...
                <td id="t16" style="width:30%">
                	<s:if test="confirm.isSecondConfirm==1">
                		是
                	</s:if>
                	<s:else>
                		否
                ...
                <td id="t14">
                	<s:if test="confirm.isSecondLinkage==1">
                		是
                	</s:if>
                	<s:else>
                		否
			   ...
			   <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
                ...
                <td id="t16" style="width:30%">
					<s:if test="confirm.isRelation==1">
                		是
                	</s:if>
                	<s:else>
                		否
			  ...
			  <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
                ...
                <td id="t14">
				 <input type="text" id="renovatePrice" name="confirm.renovatePrice" class="money" value="${confirm.renovatePrice}"/>
				元				</td>				
              </tr>	
                ...
                <td id="t14">
				 <input type="text" id="renovateMoney" name="confirm.renovateMoney" class="money" value="${confirm.renovateMoney}"/>
				元				</td>				
              </tr>	
