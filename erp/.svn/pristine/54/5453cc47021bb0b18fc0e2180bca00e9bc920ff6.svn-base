  ...
  <tr>
    ...
    <div class="right05">
      <div class="titlel"></div>
		...
		<!-- right form top -->
	<form id="commentForm" class="registerform" action="<%=request.getContextPath() %>/presale_hengda!updatePre.action" method="post" >	
           ...
           <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="gbox" >
		   	...
		   	<tr onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF";>
                ...
                <td id="t16" colspan="5">
                		...
                		<input type="text" name="presaleMonitor.phoneNum" value="${presaleMonitor.phoneNum}"/>
             ...
             <tr onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF";>
                ...
                <td id="t14" colspan="5">
					<input type="text" name="presaleMonitor.visitorNum" value="${presaleMonitor.visitorNum}"/></td>
               
              </tr>
              <tr onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF";>
                <td align="right" id="t13">当日认筹(次):</td>
                <td id="t14" colspan="5">
					<input type="text" name="presaleMonitor.intentionNum" value="${presaleMonitor.intentionNum}"/></td>
              ...
              <tr onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF";>
                ...
                <td id="t8" colspan="5">
                <input type="text"   value="${ presaleMonitor.monitorDate}" disabled="disabled"/>
              	<input type="hidden" name="presaleMonitor.monitorDate"  value="${ presaleMonitor.monitorDate}"    />
                </td>
              </tr>
