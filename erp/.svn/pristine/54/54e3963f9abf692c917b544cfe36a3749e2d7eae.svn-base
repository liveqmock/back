 ...
 <DIV style="WIDTH: 98%; HEIGHT: 100%; BACKGROUND-COLOR: #A4C3D7;padding: 1px">
	<table width="100%" class="mainbg20111112" style="height: 100%">
		<tr>
		 ...
		 <form class="registerform" action="./saleunit/contract/guangzhou/inputPayDetail.action" method="post" >	
		 ...
		 <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="gbox" >
			 ...
			 <%--  
			  <tr onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF";>
				<td id="t7"  align="right">序号&nbsp;</td>

				<td colspan="3" style="white-space:normal">	
					<input type="text" name="payDetail.orderIndex" id="orderIndex" class="leftcreateinputbox02" style="width:8%"/>	
				</td>
			  </tr>
			  --%>
              ...
              <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
                ...
                <td id="t14">
					 <input type="text" id="payName" name="payDetail.payName" class="leftcreateinputbox01"/>
				</td>
             ...
             <tr onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF";>
                ...
                <td id="t12">
				 	<input type="text" id="payMoney" name="payDetail.payMoney" class="leftcreateinputbox01" style="width:40%"/>
					元
				</td>
			 ...
			 <tr onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF";>
				...
				<td colspan="3" style="white-space:normal">	
					<input type="text" name="payDetail.remark" id="remark" class="leftcreateinputbox02" style="width:80%" />			
				</td>
			  </tr>
			   ...
			   <tr onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF"; align="center">
				<td colspan="4">
				  ...
				  <input type="hidden" name="payDetail.mainId" value="${contract.id}"/>	 
				</td>
			  </tr>
