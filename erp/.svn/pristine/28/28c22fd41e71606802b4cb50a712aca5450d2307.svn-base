							...
							<tr>
								...
								<td width="100%" valign="top" height="100%" style="overflow: hidden;">
									...
									<div class="titlebg" style="height: auto; overflow: hidden;">
										   ...
										   <div class="title02" ><a href="./sale_hengda/chart/project.action" target="_self">查看项目曲线</a></div>
										...
										<table width="100%" border="0" align="left" cellspacing="0">
											...
											<!-- 搜索表单 top -->
											 <form action="sale_hengda/chart/project.action" method="post">
	<table width="100%" border="0" align="left" cellspacing="0">
	<%-- 蓝色边条begin --%>	
		 <tr>
...
<%-- 列表 begin --%>		
     <tr>
		...
		<s:select list="listSelProject" name="saleMonitorCond.projectId" value="%{saleMonitorCond.projectId}" />
