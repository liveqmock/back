...
public class SelRating extends SupperAction {
	...
	public String getSelRating() throws Exception{
		...
		LinkedHashMap map = codeTypeServices.findCodeListForSel(EnumCodeTypeName.RATING, project.getId());
	...
	public String getSelRatingByProjectId() throws Exception{
		
		int projectId = Integer.parseInt(request.getParameter("projectId"));
		
		LinkedHashMap map = codeTypeServices.findCodeListForSel(EnumCodeTypeName.RATING, projectId, true);
