			  ...
			  <div class="titlel"></div>
			   <div class="titlebg" style=" height:auto;overflow:hidden;">
			    <div class="title01" ><a href="./sale_hengda/userAccount/search.action" target="_self">用户管理</a></div>
					 <div class="title02" ><a href="./sale_hengda/role_project/index.action" target="_self">权限管理</a></div>			
		  ...
		  <!-- 搜索表单 top -->
       		<tr>
       			<td nowrap="nowrap" colspan="3">
       				 <form action="./sale_hengda/role_project/search.action" method="get">
       			搜索权限<br/>
				<label>
					<span>选择项目</span>
			  ...
			  <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="1" class="gbox" style="vertical-align: top;" >
  				...
  				<s:iterator value="leftUserList" id="idhave">
  					<tr class="gboxbg" align="left" style="white-space: nowrap">
  						...
  						<td>&nbsp;${idhave.userAccount.descProjectId }</td>
  						<td>&nbsp;<a href="./sale_hengda/role_project/del.action?id=${idhave.userAccount.id }&selectRoleId=${selectRoleId}" target="_self" class="ablue" >移除</a></td>
  					</tr>
  				</s:iterator>
			</table>
            </div>
	   ...
	   <div class="gbox1" style="height:500px;overflow:auto;height:800">			  
			  ...
			  <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="1" class="gbox" style="vertical-align: top;" >
  				...
  				<s:iterator value="rightUserList" id="idcan">
  					...
  					<td>&nbsp;<a href="./sale_hengda/role_project/add.action?id=${idcan.id }&selectRoleId=${selectRoleId}" target="_self" class="ablue"> 赋予</a></td>
  					</tr>
  				</s:iterator>
			</table>
            </div>
