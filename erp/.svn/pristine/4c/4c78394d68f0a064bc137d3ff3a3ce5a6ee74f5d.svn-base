...
<%--主体table top --%>
	...
	<table style="width: 100%;" align="left" border="0" cellspacing="0">		  
     ...
     <form class="registerform" id="searchForm" action="<%=request.getContextPath() %>/saleunit/confirm/guangzhou/confirmInputThird.action" method="post" >
		  <tr>
		  	<td colspan="6">
   ...
   <td align="center" valign="middle" width="180">
   		<input type="button" value="  新建  " onclick="confirmCustomer('confirm')"/>
   </td>
   ...
   <s:iterator value="#request.customerList" id="c">  
	  <tr onMouseOver="this.style.backgroundColor='#f1f9fe';" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF"> 
		...
		<td align="center" valign="middle" class="fontblue">
			<a href="./saleunit/confirm/guangzhou/changeCustomerToFourth.action?unitId=${unitId}&customerId=${c.id}">选择</a>
		</td>
