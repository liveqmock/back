    ...
    <td width="100%" valign="top" height="100%" style="overflow:hidden;">
      ...
      <div class="titlel"></div>
        ...
        <div class="titlebg" style=" height:auto;overflow:hidden;">	
	        ...
	        <div class="title01"><a href="./article/search/all.action" target="_self">查询通告</a></div>	
            <div class="title02"><a href="./article/input/for_article.action" target="_self">录入通告</a></div>			
			
		   <div class="right99"></div>
			<div class="blueline"></div>
		
		<!-- right form top -->
		<form class="registerform" id ="registerform" action="./article/update/article.action" method="post" >	
          ...
          <div class="c"></div>
           ...
           <input type="hidden" name="articleId" id="articleId"value="<s:property value='#request.article.id'/>"/>
			...
			<td width="121" align="center" id="t15"  >文章类型</td>
                <td  id="t16"  >
				&nbsp;
				<input type="text"  id="articleType"  name="article.articleType"  value="<s:property value='#request.article.articleType'/>"/></td>
				<td width="163" align="center" id="t15"  >顺序</td>
                <td width="505"  id="t16" >
				&nbsp;
				<input type="text"  id="orderIndex"  name="article.orderIndex" value="<s:property value='#request.article.orderIndex'/>"/></td>
			</tr>
		   	<tr onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF";>
			<td width="121" align="center" id="t15"  >标题</td>
                <td width="191"  id="t16" >
				&nbsp;
				<input type="text"  id="title"  name="article.title" value="<s:property value='#request.article.title'/>"/></td>
				<td width="163" align="center" id="t15"  >摘要</td>
                <td width="505"  id="t16" >
				&nbsp;
				<input type="text"  id="summary"  name="article.summary" value="<s:property value='#request.article.summary'/>"/></td>
			</tr>
			...
			<td width="121" align="center" id="t15"  >内容</td>
             <td width="191"   colspan="3" >
             <textarea name="article.content" style="width:800px;height:200px;"><s:property value='#request.article.content'/></textarea>
           </td>
			</tr>
		  		<tr onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF"; align="center">
			<td colspan="6">
