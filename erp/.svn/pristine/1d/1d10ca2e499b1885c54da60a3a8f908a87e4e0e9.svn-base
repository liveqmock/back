           ...
           <tr>
			...
			<tr>
			 ...
			 <tr>
			  ...
			  <input type="button" value="  新建付款明细  " id="createAddProperty" onclick="inputPayDetailDialogForContract(${contract.id})"/>
              </td>
            </tr>
   ...
   <s:iterator value="#request.payDetailList" id="c">  
	  <tr onMouseOver="this.style.backgroundColor='#f1f9fe';" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF"> 
		...
		<td align="center" valign="middle" class="fontblue" title="点击修改">
			<a href="#" onclick="return updatePayDetailDialogForContract(${c.id})"><s:date name="#c.limitDate" format="yyyy-MM-dd "/></a>
		</td>
