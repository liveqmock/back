...
<form action="./saleunit_new_questions/appoint/guangzhou/customerTopicOrderForm.action" id="question_toc_form" method="post">	
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="gbox" style="font-size:12px; line-height:26px">
		...
		<s:iterator value="queTopicList" var="toc">
			<tr bgcolor="#ffffff">
