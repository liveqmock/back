    ...
    <div class="right05">
      <div class="titlel"></div>
        ...
        <div class="titlebg" style=" height:auto;overflow:hidden;">	
	        ...
	        <div class="title01" ><a href="./customer_oldhuijing!searchCustomer.action?from=left" target="_self">查询客户</a></div>
            <div class="title02"><a href="./customer_oldhuijing!doSomeForAddCustomer.action?from=huijing" target="_self">新建客户</a></div>			
		...
		<!-- right form top -->
	<form class="registerform" action="<%=request.getContextPath() %>/customer_oldhuijing!addCustomer.action" method="post" >	
	  ...
	  <tr onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF"; align="center">
		<td colspan="4">
		  <input type="submit" value="  保存  " id="sub"/>
			&nbsp;&nbsp;
		  <input type="button" value="  取消  " onClick="javascript:window.location.href = './customer_oldhuijing!searchCustomer.action'" />
		  &nbsp;&nbsp;
