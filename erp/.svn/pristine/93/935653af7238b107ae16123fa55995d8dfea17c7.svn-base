...
<%--主体table top --%>
   ...
   <td align="center" valign="middle" width="180">
	客户名称	</td>
     ...
     <td width="187" align="left" valign="middle">		
		...
		<input type="hidden" id="customerHiddenId" name="cond.customerId" value="${cond.customerId}"/>
	 </td>
   ...
   <td align="center" valign="middle">
	业务员	</td>
     ...
     <td width="187" align="left" valign="middle">
	 	<input type="text" id="saleName" name="cond.saleName" value="${cond.saleName}"/>
		<input type="hidden" id="saleHiddenId" name="cond.salesId" value="${cond.salesId}"/>
  ...
  <tr onMouseOver="this.style.backgroundColor='#f1f9fe';" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF">
	...
	<td width="187" align="left" valign="middle">			
		<input type="text" id="unitName" name="cond.unitName" value="${cond.unitName}"/>
		<input type="hidden" id="unitHiddenId" name="cond.unitId" value="${cond.unitId}"/>
	</td>
  ...
  <tr class="gboxbg">
   ...
   <s:iterator value="#request.appointList" id="c">  
	  <tr onMouseOver="this.style.backgroundColor='#f1f9fe';" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF"
	   title='客户名称:<s:property value="#c.customerName"/>, 预约日期:<s:date name="#c.appointDate" format="yyyy-MM-dd "/>'> 
		...
		<td align="center" valign="middle">	
			<s:property value="#c.unitName"/>
		</td>
		<td align="center" valign="middle">
			<s:property value="#c.unitNum"/>
		</td>
		
		<td align="center" valign="middle">
			<s:property value="#c.appointNum"/>
		</td>
