...
<body >
<form name="inputform" class="registerform" id="roleFormId" action="./user/manager/addPriv.action" method="post">
    ...
    <table width="100%" border="0" align="left" cellpadding="0" cellspacing="1" class="gbox">
        ...
        <tr bgcolor="#FFFFFF">
            ...
            <td align="left" valign="middle">
                <input type="text" id="privName" size="40" name="privName" />
            </td>
        ...
        <tr bgcolor="#FFFFFF">
            ...
            <td align="left" valign="middle">
                <input type="text" id="privCode" size="40" name="privCode" />
            </td>
        ...
        <tr bgcolor="#FFFFFF">
            ...
            <td align="left" valign="middle">
                <input type="text" id="remark" size="40" name="remark" value=""/>
            </td>
