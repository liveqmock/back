 ...
 * 2012-9-27
 */
public class SaleMonitorMethodInterceptor extends BaseMethodInterceptor implements MethodInterceptor{
	...
	public Object invoke(MethodInvocation invocation) throws Throwable {
		...
		String cacheName = CacheFrontName.SALE_MONITOR + methodName;
		...
		if(!isCheck(methodName)){
			...
			if(methodName.startsWith("find")){
				...
				CacheUtils.removeCacheByLikeCacheName(CacheFrontName.SALE_MONITOR);
