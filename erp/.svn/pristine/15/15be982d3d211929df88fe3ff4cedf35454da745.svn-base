...
<div id="add_owner_for_change" style="width: 550px;position: absolute;z-index: 1400;left: 50px;top: 20px;background: #777777;margin: 5px;font-size: 12px;
 display: none" >
 <form action="./saleunit/confirm/guangzhou/addForChangeOwner_addOwner.action" method="post">
...
<form action="./saleunit/confirm/guangzhou/addForChangeOwner.action" method="post">
<table bgcolor="#ffffff" style="font-size: 12"  class="gbox" width="100%" align="center" cellspacing="1" cellpadding="0" border="0">

	<tr>
		<td width="100px">手续费</td>
		<td>
			<input type="text" id="change_owner_hand_fee" name="changeOwnerForm.handFee"/>
		</td>
		<td width="100px">变更原因</td>
		<td >
			<select id="change_owner_reson_type" name="changeOwnerForm.resonType">
	...
	<tr>
		<td>原因说明</td>
		<td colspan="3">
			<input type="text" id="change_owner_reson_desc" name="changeOwnerForm.resonDesc" style="width: 100%"/>
		</td>
	</tr>
	<tr>
		<td>已交金额</td>
