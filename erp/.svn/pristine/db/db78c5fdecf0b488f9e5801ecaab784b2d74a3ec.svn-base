	...
	<head>
		...
		<script language="javascript" type="text/javascript">
			$().ready(function(){
				...
				$("#saleWeekCond_companyId").change(function(){
					companyToProject(this.value, "saleWeekCond_projectId");
				});
		...
		<table width="100%" border="0" align="left" cellspacing="0" >
			...
			<div class="right05">--%>
									...
									<div class="titlebg" style="height: auto; overflow: hidden;">
										...
										<div class="title02">
											<a href="./sale_hengda/search/week.action?from=left" target="_self">本周累计</a>
										</div>
										...
										<table width="100%" border="0" align="left" cellspacing="0">
											...
											<form action="./sale_hengda/search/week.action" method="get">
												<tr >
													<td height="0" align="left" colspan="6">
														<label>
															<span>日期</span>
														</label>
														<input class="Wdate" type="text" id="date1" name="saleWeekCond.date1" style="width: 90px" 
														value="${saleWeekCond.date1}" onClick="WdatePicker()" />
														-
														<input class="Wdate" type="text" id="date2" name="saleWeekCond.date2" style="width: 90px" 														
														value="${saleWeekCond.date2}" onClick="WdatePicker()" />
														<label>
															<span>所属公司</span>
														</label>
														<s:select list="selCompany" name="saleWeekCond.companyId" value="#session.companyId" />
														<label>
															<span>所属项目</span>
														</label>
														...
														<a href="./sale_hengda/search/downLoadWeek.action" class="ablue" >下载数据</a>
													</td>
															...
															<s:iterator value="#request.saleTypeList" id="c">
																<tr onMouseOver="this.style.backgroundColor='#FFFFBF';" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF">
																	...
																	<td align="center" valign="middle">
																		...
																		saleCond.date1=${saleWeekCond.date1}&saleCond.date2=${saleWeekCond.date2}
