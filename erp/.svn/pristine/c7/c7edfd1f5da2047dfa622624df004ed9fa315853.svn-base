			...
			<tbody>
										...
										<form class="registerform" id="registerform" action="./sale_hengda/update/for_submit.action" method="post">
											...
											<table width="750" border="0" align="left" cellpadding="0" cellspacing="1" class="gbox">
												<tr onMouseOver="this.style.backgroundColor='#ffffbf'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF";>
													...
													<td width="152" nowrap="nowrap" id="t16">
														&nbsp;
												...
												<tr onMouseOver="this.style.backgroundColor='#ffffbf'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF";>
													...
													<td width="148" nowrap="nowrap" id="t16">
														&nbsp;
														<input type="text" disabled="disabled" value="${session.saleMonitor.phoneNum }" id="phoneNum" class="leftcreateinputbox02" style="width: 70px" />														
														组
														<input type="hidden"  name="saleMonitor.phoneNum" value="${session.saleMonitor.phoneNum }" />
													</td>
													...
													<td width="226" nowrap="nowrap" id="t16">
														&nbsp;
														<input type="text" disabled="disabled" value="${session.saleMonitor.visitorNum }" id="visitorNum" class="leftcreateinputbox02" style="width: 70px" />
														个
														<input type="hidden"  name="saleMonitor.visitorNum" value="${session.saleMonitor.visitorNum }" />
													</td>
												</tr>
												...
												<tr onMouseOver="this.style.backgroundColor='#ffffbf'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF";>
													...
													<td colspan="4" align="left" nowrap="nowrap" id="t7">
														&nbsp;预售项目填写,今天认筹了
														<input type="text" disabled="disabled" value="${session.saleMonitor.intentionNum }" id="intentionNum" class="leftcreateinputbox02" style="width: 70px" />
														次
														<input type="hidden"  name="saleMonitor.intentionNum" value="${session.saleMonitor.intentionNum }" />
													</td>
												</tr>
                ...
                <td id="t14">
					退挞定面积</td> -->
												...
												<tr onMouseOver="this.style.backgroundColor='#ffffbf'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF";>
													...
													<td id="t14">
														&nbsp;
														<input disabled="disabled" type="text" value="${session.saleMonitor.houseNum }" id="houseNum" class="leftcreateinputbox01" style="width: 70px" />
														<input type="hidden" name="saleMonitor.houseNum" value="${session.saleMonitor.houseNum }" />
													</td>
													<td id="t14">
														&nbsp;
														<input type="text" disabled="disabled" value="${session.saleMonitor.houseArea}" id="houseArea" class="leftcreateinputbox01" style="width: 70px" />
														<input type="hidden" name="saleMonitor.houseArea" value="${session.saleMonitor.houseArea }" />
													</td>
													<td id="t14">
														&nbsp;
														<input type="text" disabled="disabled" value="${session.saleMonitor.houseMoney }"  id="houseMoney" class="leftcreateinputbox01" style="width: 70px" />
														<input type="hidden" name="saleMonitor.houseMoney" value="${session.saleMonitor.houseMoney }" />
													</td>
                ...
                <td id="t14">
					...
					-->
												...
												<tr onMouseOver="this.style.backgroundColor='#ffffbf'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF";>
													...
													<td id="t12">
														&nbsp;
														<input type="text" disabled="disabled" value="${session.saleMonitor.shopNum }" id="shopNum" class="leftcreateinputbox02" style="width: 70px" />
														<input type="hidden" name="saleMonitor.shopNum" value="${session.saleMonitor.shopNum }" />
													</td>
													<td id="t12">

														&nbsp;
														<input type="text" disabled="disabled" value="${session.saleMonitor.shopArea }" id="shopArea" class="leftcreateinputbox02" style="width: 70px" />
														<input type="hidden" name="saleMonitor.shopArea" value="${session.saleMonitor.shopArea }" />
													</td>
													<td id="t12">
														&nbsp;
														<input type="text" disabled="disabled" value="${session.saleMonitor.shopMoney }" id="shopMoney" class="leftcreateinputbox02" style="width: 70px" />
														<input type="hidden" name="saleMonitor.shopMoney" value="${session.saleMonitor.shopMoney }" />
													</td>
				...
				<input type="text" name="saleMonitor.undoShopArea" id="undoShopArea" class="leftcreateinputbox02" style="width:70px"/></td>-->
												...
												<tr onMouseOver="this.style.backgroundColor='#ffffbf'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF";>
													...
													<td id="t12">
														&nbsp;
														<input type="text" disabled="disabled" value="${session.saleMonitor.parkNum }" id="parkNum" class="leftcreateinputbox02" style="width: 70px" />
														<input type="hidden" name="saleMonitor.parkNum" value="${session.saleMonitor.parkNum }" />
													</td>
													<td id="t16">
														&nbsp;
														<input type="text" disabled="disabled" value="${session.saleMonitor.parkArea }" id="parkArea" class="leftcreateinputbox02" style="width: 70px" />
														<input type="hidden" name="saleMonitor.parkArea" value="${session.saleMonitor.parkArea }" />
													</td>
													<td>
														&nbsp;
														<input type="text" disabled="disabled" value="${session.saleMonitor.parkMoney }" id="parkMoney" class="leftcreateinputbox02" style="width: 70px" />
														<input type="hidden" name="saleMonitor.parkMoney" value="${session.saleMonitor.parkMoney }" />
													</td>
			  ...
			  <tr onMouseOver="this.style.backgroundColor='#ffffbf'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF"; >
				...
				<td id="t13" >&nbsp;<input type="text" disabled="disabled" id="contractHouseNum" value="${session.saleMonitor.contractHouseNum }" class="leftcreateinputbox02" style="width:70px"/>
				<input type="hidden" name="saleMonitor.contractHouseNum" value="${session.saleMonitor.contractHouseNum }" /></td>
                <td id="t14">&nbsp;<input type="text" disabled="disabled" id="contractHouseArea"  value="${session.saleMonitor.contractHouseArea }" class="leftcreateinputbox02" style="width:70px"/>	
				<input type="hidden" name="saleMonitor.contractHouseArea" value="${session.saleMonitor.contractHouseArea }" />		</td>
				<td id="t14">&nbsp;<input type="text" disabled="disabled" id="contractHouseMoney" value="${session.saleMonitor.contractHouseMoney }" class="leftcreateinputbox02" style="width:70px"/>
				<input type="hidden" name="saleMonitor.contractHouseMoney" value="${session.saleMonitor.contractHouseMoney }" />
				<font color="#0000FF"><span id="contractHouseMoneySum"></span></font></td>
				
				  <tr onMouseOver="this.style.backgroundColor='#ffffbf'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF";>
			
                <td id="t11" align="center">商铺</td>
                <td id="t12">&nbsp;<input type="text" disabled="disabled" id="contractShopNum" value="${session.saleMonitor.contractShopNum }" class="leftcreateinputbox02" style="width:70px"/>
				<input type="hidden" name="saleMonitor.contractShopNum" value="${session.saleMonitor.contractShopNum }" /></td>
                <td id="t12">&nbsp;<input type="text" disabled="disabled" id="contractShopArea" value="${session.saleMonitor.contractShopArea }" class="leftcreateinputbox02" style="width:70px"/>
				<input type="hidden" name="saleMonitor.contractShopArea" value="${session.saleMonitor.contractShopArea }" /></td>
					<td id="t12">&nbsp;<input type="text" disabled="disabled" id="contractShopMoney" value="${session.saleMonitor.contractShopMoney }" class="leftcreateinputbox02" style="width:70px"/>
					<input type="hidden" name="saleMonitor.contractShopMoney" value="${session.saleMonitor.contractShopMoney }" />
              ...
              <!--   <td id="t11" align="center"><input type="text" name="saleMonitor.undoShopNum" id="undoShopNum" class="leftcreateinputbox02" style="width:70px"/></td>
               ...
               <tr onMouseOver="this.style.backgroundColor='#ffffbf'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF";>
                ...
                <td id="t15" align="center">车位</td>
                 <td id="t9" >&nbsp;<input type="text" disabled="disabled" id="contractParkNum" value="${session.saleMonitor.contractParkNum }" class="leftcreateinputbox02" style="width:70px"/>
				 <input type="hidden" name="saleMonitor.contractParkNum" value="${session.saleMonitor.contractParkNum }" /></td>
                <td id="t10">&nbsp;<input type="text" disabled="disabled" id="contractParkArea" value="${session.saleMonitor.contractParkArea }" class="leftcreateinputbox02" style="width:70px"/>
				<input type="hidden" name="saleMonitor.contractParkArea" value="${session.saleMonitor.contractParkArea }" /></td>           		
				<td>&nbsp;<input type="text" disabled="disabled" id="contractParkMoney" value="${session.saleMonitor.contractParkMoney }" class="leftcreateinputbox02" style="width:70px"/>
				<input type="hidden" name="saleMonitor.contractParkMoney" value="${session.saleMonitor.contractParkMoney }" />
              ...
              <tr onMouseOver="this.style.backgroundColor='#ffffbf'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF";>
				...
				<!--     -->
												...
												<tr onMouseOver="this.style.backgroundColor='#ffffbf'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF";>
													...
													<td id="t14">
														&nbsp;
														<input type="text" name="saleMonitor.undoHouseMoney" value="${session.saleMonitor.undoHouseMoney }" id="undoHouseMoney" class="leftcreateinputbox02" style="width: 70px" /><font color="#0000FF"><span id="MundoHouseMoney"></span></font>
													</td>
													...
													<tr onMouseOver="this.style.backgroundColor='#ffffbf'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF";>
														...
														<td id="t12">
															&nbsp;
															<input type="text" name="saleMonitor.undoShopMoney" value="${session.saleMonitor.undoShopMoney }" id="undoShopMoney" class="leftcreateinputbox02" style="width: 70px" /><font color="#0000FF"><span id="MundoShopMoney"></span></font>
														</td>
													...
													<tr onMouseOver="this.style.backgroundColor='#ffffbf'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF";>
														...
														<td>
															&nbsp;
															<input type="text" name="saleMonitor.undoParkMoney" value="${session.saleMonitor.undoParkMoney }" id="undoParkMoney" class="leftcreateinputbox02" style="width: 70px" /><font color="#0000FF"><span id="MundoParkMoney"></span></font>
														</td>
														<!--  -->
													</tr>
													<tr onMouseOver="this.style.backgroundColor='#ffffbf'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF";>
