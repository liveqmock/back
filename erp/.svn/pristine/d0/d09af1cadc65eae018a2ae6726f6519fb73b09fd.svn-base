 ...
 <DIV style="WIDTH: 98%; HEIGHT: 100%; BACKGROUND-COLOR: #A4C3D7;padding: 1px">
	<table width="100%" class="mainbg20111112" style="height: 100%">
		<tr>
		 ...
		 <form class="registerform" action="./saleunit/contract/guangzhou/inputContractRenovate.action" method="post" >	
		 ...
		 <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="gbox" >
             ...
             <tr onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF";>
                ...
                <td id="t12">	
					<input type="text" id="payName" name="contractRenovate.payName" class="leftcreateinputbox01" />		
				</td>
				
                <td id="t11"  align="right">金额&nbsp;</td>
                <td id="t12">
				 	<input type="text" id="payMoney" name="contractRenovate.payMoney" class="leftcreateinputbox01" style="width:40%"/>
					元
				</td>
			   ...
			   <tr onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF"; align="center">
				<td colspan="4">
				  ...
				  <input type="hidden" name="contractRenovate.contractId" value="${contractId}"/>	 
				</td>
			  </tr>
