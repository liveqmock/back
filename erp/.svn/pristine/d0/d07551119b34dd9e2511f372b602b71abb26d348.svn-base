...
<div data-role="page" id="modify_own_question">

	<form id="modify_own_question_form" action="<%=basePath%>m/modifyOwnHaveAnswerQuestion.action" method="post">
	...
	<div data-role="content">
         ...
         <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" style="text-align:center">
          ...
          <s:iterator value="#request.questionDetailList" id="c">
            ...
            <tr>
            	<td colspan="2">
                   ...
                   <input type="hidden" id="anwserId" name="anwserId" value="${anwser.id}" />
