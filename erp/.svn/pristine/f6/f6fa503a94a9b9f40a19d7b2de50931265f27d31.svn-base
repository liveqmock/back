...
<title>单项比例分析图</title>
							...
							<tr>
								...
								<td width="100%" valign="top" height="100%" style="overflow: hidden;">
									...
									<div class="titlebg" style="height: auto; overflow: hidden;">
										   ...
										   <div class="title02" ><a href="./sale_hengda/chart/customerPie.action" target="_self">单项比例分析图</a></div>
 ...
 <form class="registerform" action="<%=request.getContextPath() %>/sale_hengda/chart/customerPie.action" method="post" >
     <tr>
     	<td colspan="6">	
