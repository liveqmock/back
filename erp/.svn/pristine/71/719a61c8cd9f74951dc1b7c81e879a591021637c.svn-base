...
<table width="90%" border="0" align="left" cellpadding="0" cellspacing="1" class="gbox" id="exTable">
  ...
  <tr onMouseOver="this.style.backgroundColor='#f1f9fe';" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" style="line-height: 20px; text-align:center"> 
  	<td>
		<a href="#" style="color:#1199FF; text-decoration:underline" onclick="return canShowOrUpdate(false)">查看</a>
	</td>
	
	<td>
		<a href="#" id="add" style="color:#1199FF; text-decoration:underline" onclick="return extensionContractAddDiv()">新建</a>
	</td>
	
	<td>
		<a href="#" id="update" style="color:#1199FF; text-decoration:underline" onclick="return canShowOrUpdate(true)">修改</a>
	</td>
	
	<td>
		<a href="#" id="delete" style="color:#1199FF; text-decoration:underline" onclick="return canDelete()">删除</a>
	</td>
