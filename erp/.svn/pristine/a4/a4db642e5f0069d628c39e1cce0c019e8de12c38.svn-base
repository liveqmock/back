		 ...
		 <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="gbox" >		
              ...
              <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
                ...
                <td id="t16" style="width:30%" class="fontblue">
				 ...
				 <input type="text" id="customerName" name="confirmCustomerName" class="leftcreateinputbox01" style="width:50%"/>
				 <input type='hidden' id='confirmCustomerId' name="confirm.customerId"/>
				 <a href="#" onclick="return false;" id="createConfirmCustomer">新建客户</a>
				 
			    </td>
				<td id="t15" style="width:15%" align="right"><font color="#FF0000">*</font>联系电话&nbsp;</td>
                <td id="t16" style="width:30%">
			 	
				 <input type="text" id="phone" name="confirm.phone" class="leftcreateinputbox01" />
			  ...
			  <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
				...
				<td colspan="3">
					<input type="text" id="unitName" name="unitName" class="leftcreateinputbox01"/>
      			 	<input type="hidden" id="hiddenUnitId" name="confirm.unitId" />
				</td>
			   ...
			   <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
                ...
                <td id="t16" style="width:30%">
					<input type="text" id="discountPercent" name="confirm.discountPercent" class="leftcreateinputbox01" />
				 </td>			
              </tr>	 
			   ...
			   <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
                ...
                <td id="t14">
				 	<span id="buildPrice"></span>
				</td>		
               <td id="t13" style="width:15%" align="right"><font color="#FF0000">*</font>套内成交单价&nbsp;</td>
                <td id="t14">
					 <input type="text" id="insideUnitPrice" name="confirm.insideUnitPrice" class="leftcreateinputbox01" />
				</td>		
              </tr>	 
			   ...
			   <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
                ...
                <td id="t16" style="width:30%">
				 <input type="text" id="discountDesc" name="confirm.discountDesc" class="leftcreateinputbox01"/>
				 </td>		
                <td id="t15" style="width:15%" align="right"><font color="#FF0000">*</font>房间总价&nbsp;</td>
                <td id="t16" style="width:30%">
					 <input type="text" id="sumMoney" name="confirm.sumMoney" class="leftcreateinputbox01" />
				 </td>			
              </tr>	 
			  ...
			  <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
                ...
                <td id="t16" style="width:30%">
					<span id="renovateDesc"></span>
				 </td>
                 <td id="t13" style="width:15%" align="right">装修单价&nbsp;</td>
                <td id="t14">
					<span id="renovatePrice"></span>
				</td>				
              </tr>	
                ...
                <td id="t16" style="width:30%">
					<s:select list="selIsMerge" name="confirm.isMerge" cssStyle="width:auto" id="isMerge"/>
				 </td>
                 <td id="t13" style="width:15%" align="right">装修总价&nbsp;</td>
                <td id="t14">
					<span id="renovateMoney"></span>
				</td>				
              </tr>	
			  ...
			  <tr bgcolor="#E9F5FF" style="empty-cells:show">
			   ...
			   <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
                ...
                <td id="t16" style="width:30%">
				 <input type="text" id="agreeNo" name="confirm.agreeNo" class="leftcreateinputbox01"/>
				 </td>
			  ...
			  <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
                ...
                <td id="t16" style="width:30%">
				   <input type="text" id="shouldDeposit" name="confirm.shouldDeposit" class="leftcreateinputbox01" />
			    </td>
			  ...
			  <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
                ...
                <td id="t14">
				 <input type="text" id="recommendMan" name="confirm.recommendMan" class="leftcreateinputbox01"/>
				</td>				
              </tr>	
			  ...
			  <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
                ...
                <td id="t16" style="width:30%">
					...
					<input type="hidden" id="hiddenSalesId" name="confirm.salesId"/>
			    </td>
			  ...
			  <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
                ...
                <td id="t14">
					 ...
					 <input type="hidden" id="hiddenRefUnitId" name="confirm.refUnitId" />
				</td>	
                 <td id="t13" style="width:15%" align="right"></td>
                <td id="t14"></td>				
              </tr>	 
