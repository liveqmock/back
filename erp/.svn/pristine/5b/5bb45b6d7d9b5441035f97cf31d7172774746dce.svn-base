...
<%--主体导航页头 --%>
<div class="title01" ><a href="<%=basePath%>saleunit/change/guangzhou/searchList.action" target="_self">查询变更</a></div>
<div class="title02"><a href="<%=basePath%>saleunit/change/guangzhou/getById.action?id=12" target="_self">修改变更</a></div>	
			   ...
			   <tr onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF"; align="center">
				<td colspan="4">
				  ...
				  <input type="hidden" name="appoint.id"  value="${appoint.id}"/>
					&nbsp;&nbsp;
				  <input type="button" value="  取消  " onClick="javascript:window.location.href = '<%=basePath%>saleunit/change/guangzhou/searchList.action'" />
				</td>
			  </tr>
