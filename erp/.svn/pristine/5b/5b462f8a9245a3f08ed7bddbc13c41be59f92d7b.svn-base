...
<script type="text/javascript" src="<%=basePath%>ui/js/jquery.easyui.min.js"></script>
...
<script language="javascript" type="text/javascript" src="<%=basePath%>js/money.utils.js"></script>