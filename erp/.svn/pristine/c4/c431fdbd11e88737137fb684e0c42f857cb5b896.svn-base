...
<img src="<%=basePath%>images/tianluan/arrow01.gif" width="9" height="90" border="0" id="img" class="img" title="点击收缩"/>
 ...
 <!--left.end-->
    ...
    <!-- 菜单开始 -->
	    ...
	    <div class="title01" ><a href="./priv_func!privfunc_list.action" target="_self">查询功能权限</a></div>
...
<!-- 搜索表单 begin -->
	...
	<form class="registerform" action="<%=request.getContextPath() %>/priv_func!tree_added.action" method="post" >
	...
	<!-- 蓝色边条begin -->
		 ...
		 <tr>
  			...
  			<td height="10" ><div class="c"></div></td>
...
<tr><td>
 <table width="50%" border="0" align="left" cellpadding="0" cellspacing="1" class="gbox" >
      <tr onmouseover="this.style.backgroundColor='#f1f9fe'" onmouseout="this.style.backgroundColor=''" bgcolor="#FFFFFF";>
          <td width="29%" align="center" id="t13">功能树名称</td>
            <td width="71%" id="t14">
				&nbsp;
		<s:select list="selPrivFunc" name="privFunc.treeCode"></s:select>
		</td>
				
       </tr>
		<tr onmouseover="this.style.backgroundColor='#f1f9fe'" onmouseout="this.style.backgroundColor=''" bgcolor="#FFFFFF";>
				<td width="29%" align="center"" id="t13">权限名称</td>
                <td width="71%" id="t14">
                &nbsp;
                <s:select list="selPriv" name="privFunc.privCode"></s:select>
				</td>  
        </tr>
