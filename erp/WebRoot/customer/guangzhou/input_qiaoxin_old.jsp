...
<%--主体table top --%>
	  ...
	  <form class="registerform" action="./customer_guangzhou/input/addCustomer.action?ts=<%= CacheUtils.getUrlTimeStamp()%>" method="post" >	
		 ...
		 <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="gbox" >
			  ...
			  <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
                ...
                <td id="t16" colspan="3">
					...
					<input type="hidden" id="hiddenId" value="<s:property value='#request.project.id'/>"/>
             ...
             <tr onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF";>
			  ...
			  <!-- 侨鑫 top -->
			   ...
			   <tr onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF";>
                ...
                <td id="t12">	
					<input type="text" name="customer.rejectFactor" id="rejectFactor" class="leftcreateinputbox01"/>					
				</td>
                <td id="t11" align="right"><font color="red">*</font>意向单价&nbsp;</td>
                <td id="t12">
					<input type="text" name="customer.ratingRemark" id="ratingRemark" class="leftcreateinputbox01" style="width:40px" />
					万/㎡
				</td>
              </tr>
			   ...
			   <tr onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF";>
                ...
                <td id="t12">
					<s:select list="selIntentLease"  name="customer.intentLease"/>
				</td>
                <td id="t11"  align="right"><font color="red">*</font>客户形象&nbsp;</td>
                <td id="t12">	
					<s:select list="selWage"  name="customer.wage" />				
				</td>
			   ...
			   <tr onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF";>
                ...
                <td id="t12">
					<input type="text" name="customer.faceLook" id="faceLook" class="leftcreateinputbox01"/>
					
				</td>
                <td id="t11"  align="right"><font color="red">*</font>家庭谁作主&nbsp;</td>
                <td id="t12">	
					<input type="text" name="customer.family" id="family" class="leftcreateinputbox01"/>	
			   ...
			   <tr onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF";>
                ...
                <td id="t12">
					<input type="text" name="customer.interest" id="interest" class="leftcreateinputbox01"/>	
					
				</td>
                <td id="t11"  align="right"><font color="red">*</font>认识关系&nbsp;</td>
                <td id="t12">	
					<input type="text" name="customer.relationDesc" id="relationDesc" class="leftcreateinputbox01"/>			
				</td>
                <td id="t11" align="right"></td>
                <td id="t12"></td>
              </tr>
            ...
            <tr>
             ...
             <tr onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF";>
                ...
                <td id="t6">
				 ...
				 <td id="t9" style="width:15%" align="right">
				 </td>
                <td id="t6">					
				</td>
	   ...
	   <tr onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF";>
		...
		<td colspan="5" style="white-space:normal">
			<table width="98%" border="0" align="left" cellpadding="0" cellspacing="1" style="white-space:normal" id="knownFrom">
				<tr>
					<td>
	  ...
	  <tr onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF";>
	   ...
	   <tr onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF";>
		...
		<td colspan="5" style="white-space:normal">	
			<input type="text" name="customer.notBuyReson" id="notBuyReson" class="leftcreateinputbox02" style="width:80%"/>			
		</td>
	  </tr>
	   ...
	   <tr onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF";>
	    ...
	    <tr onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF";>
                ...
                <td id="t6">					
					<input type="text" id="subject1" name="customer.subject1" />
				</td>
				 <td id="t6">
				 	<input type="text" id="content1" name="customer.content1" />
				 </td>
                <td id="t5"  align="right">自填选项内容2&nbsp;</td>
                <td id="t6">
					<input type="text" id="subject2" name="customer.subject2" />
				</td>
                <td id="t5"  align="right">
					<input type="text" id="content2" name="customer.content2" />
				</td>
		...
		<tr onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF";>
                ...
                <td id="t6">					
					<input type="text" id="subject3" name="customer.subject3" />
				</td>
				 <td id="t6">
				 	<input type="text" id="content3" name="customer.content3" />
				 </td>
                <td id="t5"  align="right">自填选项内容4&nbsp;</td>
                <td id="t6">
					<input type="text" id="subject4" name="customer.subject4" />
				</td>
                <td id="t5"  align="right">
					<input type="text" id="content4" name="customer.content4" />
				</td>
