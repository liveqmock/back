...
<div class="ui_listview">
    ...
    <form class="registerform" action="./customer_guangzhou/update/toUpdate.action?ts=<%= CacheUtils.getUrlTimeStamp()%>" method="post" >	
	  ...
	  <tr onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF";>
		...
		<td colspan="5" style="white-space:normal"><input type="text" name="customer.remark1" id="remark1" value="<s:property value='#session.c.remark1'/>" class="" style="width:80%" maxlength="100"/>	
		</td>
	  </tr>
