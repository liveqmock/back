...
<%--主体导航页头 --%>
<div class="title02" ><a href="./customer_guangzhou/chart/customerNum.action" target="_self">客户数量环比图 </a></div>
...
<%--主体table top --%>
   ...
   <form class="registerform" action="<%=request.getContextPath() %>/customer_guangzhou/chart/customerNum.action" method="post" >
		  <tr>
     	<td colspan="6">	
