...
<%--主体table top --%>
	  ...
	  <form class="registerform" action="./customer_guangzhou/update/toUpdate.action" method="post" >	
	  ...
	  <tr onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF";>
		...
		<td colspan="5" style="white-space:normal">	
			<input type="text" name="customer.relationDesc" id="relationDesc" value="<s:property value='#session.c.relationDesc'/>" class="leftcreateinputbox02" style="width:80%"/>	
		</td>
	  </tr>
	  ...
	  <tr onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF";>
		...
		<td colspan="5" style="white-space:normal">	
			<input type="text" name="customer.remark3" id="remark3" value="<s:property value='#session.c.remark3'/>" class="leftcreateinputbox02" style="width:80%"/>	
		</td>
	  </tr>
	  ...
	  <tr onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF";>
		...
		<td colspan="5" style="white-space:normal">	
			<input type="text" name="customer.remark4" id="remark4" value="<s:property value='#session.c.remark4'/>" class="leftcreateinputbox02" style="width:80%"/>	
		</td>
	  </tr>
