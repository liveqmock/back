  ...
  <tr>
    ...
    <div class="right05">
      <div class="titlel"></div>
		...
		<!-- right form top -->
	<form class="registerform" action="<%=request.getContextPath() %>/customer_oldhuijing!updateCustomer.action" method="post" >	
	  ...
	  <tr onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF"; align="center">
		<td colspan="4">
		  ...
		  <input type="submit" value="  保存  " id="sub"/>
			&nbsp;&nbsp;
		  <input type="button" value="  取消  " onClick="javascript:window.location.href = './customer_oldhuijing!searchCustomer.action?from=return'" />
		  &nbsp;&nbsp;
