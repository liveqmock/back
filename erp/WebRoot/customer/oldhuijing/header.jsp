...
<html>
  <head>
	...
	<script type="text/javascript" language="javascript" src="./js/customer_oldhuijing.js"></script>	
...
<div class="boxnavtop">
	...
	<div class="welcome">
		...
		<a href="./customer_oldhuijing!customerLoginOut.action" title="注销" target="_self">注销</a> 
