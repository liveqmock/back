    ...
    <div class="right05">
      <div class="titlel"></div>
        <div class="titlebg" style=" height:auto;overflow:hidden;">
	        ...
	        <div class="title02" ><a href="./customer_tianluan!searchCustomer.action?from=left" target="_self">查询客户</a></div>
       ...
       <form action="customer_tianluan!searchCustomer.action" method="get">
  ...
  <tr class="gboxbg">
	...
	<table width="99" height="28"  border="0" align="center" cellspacing="0">
      <tr>
		...
		<table width="5" border="0" cellspacing="0">
          <tr>
            <td><a href="customer_tianluan!searchCustomer.action?ob=14"><img src="images/blue/upn.gif" width="9" height="10" border="0" /></a></td>
          </tr>
          <tr>
            <td><a href="customer_tianluan!searchCustomer.action?ob=13"><img src="images/blue/downopen.gif" width="9" height="10" border="0" /></a></a></td>
          </tr>
        </table>
	  </td>
      </tr>
	...
	<table width="100" height="28"  border="0" align="center" cellspacing="0">
      <tr>
        ...
        <td align="center" valign="middle"><table width="5" border="0" cellspacing="0">
          <tr>
            <td><a href="customer_tianluan!searchCustomer.action?ob=16"><img src="images/blue/upn.gif" width="9" height="10" border="0" /></a></td>
          </tr>
          <tr>
            <td><a href="customer_tianluan!searchCustomer.action?ob=15"><img src="images/blue/downopen.gif" width="9" height="10" border="0" /></a></td>
          </tr>
        </table>
	</td>
      </tr>
	...
	<table width="100" height="28"  border="0" align="center" cellspacing="0">
      <tr>
        ...
        <td align="center" valign="middle"><table width="5" border="0" cellspacing="0">
          <tr>
            <td><a href="customer_tianluan!searchCustomer.action?ob=12"><img src="images/blue/upn.gif" width="9" height="10" border="0" /></a></td>
          </tr>
          <tr>
            <td><a href="customer_tianluan!searchCustomer.action?ob=11"><img src="images/blue/downopen.gif" width="9" height="10" border="0" /></a></td>
          </tr>
        </table>
	</td>
      </tr>
	  ...
	  <tr onMouseOver="this.style.backgroundColor='#f1f9fe';" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF"
	   title='客户名称:<s:property value="#c.customerName"/>, 电话:<s:property value="#c.phone"/>'> 
		...
		<td align="center" valign="middle" class="fontblue">
			<a href="./customer_tianluan!queryCustomerById.action?id=<s:property value='#c.id'/>" target="_self" ><s:property value="#c.customerName"/></a>
		</td>
		<td align="center" valign="middle">
