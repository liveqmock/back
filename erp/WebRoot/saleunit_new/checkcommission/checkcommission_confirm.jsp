...
<head>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            $('#tbList').datagrid({
                ...
                columns:[[
                    ...
                    {field:'commission',title:'佣金点(%)',align:"center",formatter:formatPrice,width:$(this).width() * 0.2},
                    {field:'commissionAmount',title:'应收佣金(元)',align:"center",hidden:false,formatter:formatPrice,width:$(this).width() * 0.2},
                    ...
                    */{field:'rel_commission',title:'关系户佣金点(%)',align:"center",formatter:formatPrice,width:$(this).width() * 0.2},
                    {field:'rel_commissionAmount',title:'关系户应收佣金(元)',align:"center",hidden:false,formatter:formatPrice,width:$(this).width() * 0.2},

                    {field:'repayMoney',title:'回款金额(元)',align:"right",formatter:formatPrice,width:$(this).width() * 0.2},
                    {field:'repayAmount',title:'合计回款金额(元)',align:"right",formatter:formatPrice,width:$(this).width() * 0.2},
                    {field:'receiptId',title:'实收款ID',hidden:true},
        ...
        function exportExcel(){
            ...
            location.href = './saleunit_new/checkcommission/exportExcel_Mod.action?projectIds='+projectIds +"&checkCommissionDate="+checkCommissionDate+"&checkCommissionType="+$("#checkCommissionType").combobox("getValue");
        }
