	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="gbox" style="font-size:12px; line-height:26px">	
	  ...
	  <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
		...
		<td id="t14">
			...
			<input type="text" id="idcardNo" name="customer.idcardNo" onchange="valueChangeGetCount('idcardNo', 'idcardNoCount', 30)" onmousedown="valueChangeGetCount('idcardNo', 'idcardNoCount', 30)"
	  ...
	  <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
		...
		<td id="t14">
			<input type="text" id="householdProvince" name="customer.householdProvince" />
			<input type="text" id="householdCity" name="customer.householdCity" />
			<input type="text" id="householdRegion" name="customer.householdRegion" />
			<input type="text" id="householdContent"  name="customer.householdContent" style="width:95%; height:20px"/>
		</td>		
	  </tr>	 
	  ...
	  <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
		...
		<td id="t14">
			<input type="text" id="homeProvince" name="customer.homeProvince" />
			<input type="text" id="homeCity" name="customer.homeCity"  />
			<input type="text" id="homeRegion" name="customer.homeRegion"  />
			<input type="text" id="homeContent" name="customer.homeContent"  style="width:95%; height:20px"/>
		</td>		
	  </tr>	 
	  ...
	  <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
		...
		<td id="t14">
			<input type="text" id="workProvince" name="customer.workProvince" />
			<input type="text" id="workCity" name="customer.workCity" />
			<input type="text" id="workRegion" name="customer.workRegion" />
			<input type="text" id="workContent" name="customer.workContent" style="width:95%; height:20px"/>
		</td>		
	  </tr>	 
