	...
	<script type="text/javascript" language="javascript" src="./js/saleunit_new_common_min.js"></script>
	 ...
	 <script type="text/javascript" language="javascript">
		 ...
		 function loadClose(){
			...
			%>			
			window.setTimeout(function(){window.parent.closeUpdateExtension();}, 1000);
			<%
				}
			%>		
...
<body>
	...
	<form id="updateExtensionContractForm" action="./saleunit_new/appoint/guangzhou/updateExtensionContract.action" method="get">
	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="gbox" style="font-size:12px; line-height:26px">			
		...
		<td id="t16" style="width:70%">&nbsp;&nbsp;<input class="easyui-datebox" type="text" id="applyTime" 
        	style="width:90px" name="extensionContract.applyTime" value='<s:date name="extensionContract.applyTime" format="yyyy-MM-dd "/>'/>
        	<!--
        	<input class="Wdate" id="applyTime" style="width:90px" 
			name="extensionContract.applyTime" value='<s:date name="extensionContract.applyTime" format="yyyy-MM-dd "/>' />
            -->
		</td>
		</tr>
		...
		<input type="hidden" value="${extensionContract.id}" name="extensionContract.id" />
		</td>
		</tr>
		...
		<td id="t16" style="width:70%">&nbsp;&nbsp;<input name="extensionContract.extensionDay" id="extensionDay" class="easyui-numberspinner" 
			min="0" value="${extensionContract.extensionDay}" required="false" style="width:90px;"></input></td>
		</tr>
		
		 <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" style="empty-cells:show">
		<td id="t15" style="width:30%" align="center"><font color="#FF0000">*</font>改为签约日期</td>
		<td id="t16" style="width:70%">&nbsp;&nbsp;<input class="easyui-datebox" type="text" id="newApplyTime" 
        	style="width:90px" value='${extensionContract.newApplyTime}'/>
        	<!--
        	<input class="Wdate" id="newApplyTime" style="width:90px" value='${extensionContract.newApplyTime}'/>
            -->
            </td>
		</tr>
		...
		<td id="t16" style="width:70%">&nbsp;&nbsp;<textarea style="font-size:12px; width:80%; height:60px"  id="extensionReason" 
			name="extensionContract.extensionReason">${extensionContract.extensionReason}</textarea></td>
		</tr>
		...
		<td id="t16" style="width:70%">&nbsp;&nbsp;<input type="text" id="approvedMan" name="extensionContract.approvedMan" value="${extensionContract.approvedMan}"/></td>
		</tr>
		
		 <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" style="empty-cells:show">
		<td id="t15" style="width:30%" align="center">延期批准日期</td>
		<td id="t16" style="width:70%">&nbsp;&nbsp;<input class="easyui-datebox" type="text" id="approvedDay" 
        	style="width:90px" name="extensionContract.approvedDay" value='<s:date name="extensionContract.approvedDay" format="yyyy-MM-dd "/>' />
        	<!--
        	<input class="Wdate" id="approvedDay" value='<s:date name="extensionContract.approvedDay" format="yyyy-MM-dd "/>' 
			name="extensionContract.approvedDay" style="width:90px"/>
            -->
        	</td>
		</tr>		
