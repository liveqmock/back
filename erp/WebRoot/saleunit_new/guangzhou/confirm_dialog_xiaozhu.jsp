...
<head>
	...
	<script type="text/javascript" language="javascript">
		$().ready(function(){
			...
			initContractCustomerDataGrid("salesId", "${unit.id}", "${confirmType}", "customerId", "customer_table", "${url}");
		});
...
<form action="./saleunit_new/appoint/guangzhou/saveXiaoZhuConfirmDialog.action" method="post" id="xiaoZhuConfirmFormId">
