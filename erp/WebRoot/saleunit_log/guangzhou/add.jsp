...
<div class="title02" ><a href="<%=request.getContextPath() %>/saleunit/log/guangzhou/forInput.action" target="_self">当天日志</a></div>
...
<%--主体table top --%>
	  ...
	  <form class="registerform" action="<%=request.getContextPath() %>/saleunit/log/guangzhou/inputLog.action" method="post" >	
		 ...
		 <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="gbox" >		  		   
              <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
                ...
                <td id="t16" style="width:30%">
					...
					<input type="hidden" id="hiddenId" name="saleDaily.propertyId" />
				 </td>
                 <td id="t13" style="width:15%" align="right">日期&nbsp;</td>
                <td id="t14">
					 <input type="text" id="saleDate" class="Wdate"  name="saleDaily.saleDate"  />
				</td>				
              </tr>		
               <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
			  	style="empty-cells:show">
                ...
                <td id="t16" style="width:30%">
				 <input type="text" id="phoneNum" name="saleDaily.phoneNum" class="leftcreateinputbox01"/>
				 </td>
                 <td id="t13" style="width:15%" align="right">来访&nbsp;</td>
                <td id="t14">
					 <input type="text" id="visitNum" name="saleDaily.visitNum" class="leftcreateinputbox01" />
				</td>				
			  ...
			  <tr bgcolor="#FFFFFF">
               ...
               <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
                ...
                <td id="t16" style="width:90%" colspan="3">
				 <input type="text" id="unitId" name="saleDaily.unitId" class="leftcreateinputbox01" style="width:90%"/>
				 </td>		
              </tr>
