...
<div class="gbox1">
    ...
    <form action="./saleunit_new_init/appoint/guangzhou/copyContractManager.action" method="post" id="contractManagerFormId">
        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="gbox" style="font-size:12px; line-height:26px">
            ...
            <tr bgcolor="#FFFFFF" style="empty-cells:show">
                ...
                <td >
                    <input type="text" id="contractNo" name="contractManager.contractNo" value="${contractManager.contractNo}" style="width:100px"/>
                </td>

                <td style="width:15%" align="right">发展商名称&nbsp;</td>
                <td style="width:30%">
                    <input type="text" id="developerName" name="contractManager.developerName" value="${contractManager.developerName}" style="width:200px"/>
                </td>
            </tr>
            ...
            <tr bgcolor="#FFFFFF" style="empty-cells:show">
                ...
                <td style="width:15%" align="right">终止日期&nbsp;</td>
                <td style="width:30%">
			...
			<tr bgcolor="#FFFFFF" style="empty-cells:show;">
                ...
                <td style="width:30%"><s:radio name="contractManager.contractType" list="selContractType" theme="simple"></s:radio></td>
            </tr>
			
			 <tr bgcolor="#FFFFFF">

                <td style="width:15%" align="right">前期月费&nbsp;</td>
                <td colspan="3">
			 ...
			 <tr bgcolor="#FFFFFF">
                ...
                <td colspan="3">                   
                    备注<input type="text" id="feeMemo" name="contractManager.feeMemo" value="${contractManager.feeMemo}" style="width:350px"/>
                </td>
            </tr>
			...
			<tr bgcolor="#FFFFFF" style="empty-cells:show;">
                ...
                <td>
                   <input type="text" id="saleBuildArea" name="contractManager.saleBuildArea" style="width:70px" value="${contractManager.saleBuildArea}" />㎡

                </td>
                <td style="width:15%" align="right">可售货量&nbsp;</td>
                <td style="width:30%">
					<input type="text" id="saleCargoCount" name="contractManager.saleCargoCount" style="width:50px" value="${contractManager.saleCargoCount}" />套
                </td>
            </tr>
            ...
            <tr bgcolor="#FFFFFF">
                ...
                <td colspan="3">
                    <input type="text" id="defaultCommission" name="contractManager.defaultCommission" value="${contractManager.defaultCommission}" style="width:50px"/>%
                </td>
            </tr>
            ...
            <tr bgcolor="#FFFFFF">
                ...
                <td colspan="3" height="30">
                    <a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-add',disabled:${isShow}" onClick="barRule(0)">添加跳BAR规则</a>
					<a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-edit',disabled:${isShow}" onClick="modifyBarRule()">查看</a>
            ...
            <tr bgcolor="#FFFFFF">
				...
				<table id="viewbar_table" class="easyui-datagrid" data-options="fitColumns:true,singleSelect:true,loadMsg:'加载中...',
					url:'./saleunit_new_init/appoint/guangzhou/getBarRuleListByManagerIdForCopy.action?id=${contractManager.id}'">
					...
					<thead>
						<tr>
                            ...
                            <th field="rate">销售率(%)</th>
							<th field="contractRate">签约率(%)</th>							
