...
<html xmlns="http://www.w3.org/1999/xhtml">
 ...
 <style type="text/css">  
	...
	<div style="width:90%;height:auto;padding:10px 20px">
		<form method="post" id="input_project_form" action="./projecr/manager/updateProjectForm.action">
			...
			<div class="fitem">  
				...
				<input size="10" type="hidden" name="inputProject.id"
				value="${inputProject.id}"  /> 
            </div> 
			 <div class="fitem">  
                <label>公司:</label>  
                 <input size="10" type="text" 
				value="${inputProject.descCompanyId}"  style="width: 200px" disabled="disabled"/>
            </div> 
            ...
            <div class="fitem">  
                <label>创建人:</label>  
                <input size="10" type="text" 
				value="${inputProject.descCreatedId}"  style="width: 200px" disabled="disabled"/>
            </div> 
            <br />
			<div class="fitem">  
                <label>注意事项:</label>创建人在当天能修改项目,如超出时间请联系系统管理人员
            </div> 
