...
DateInput.prototype = {
  build: function() {
    var monthNav = $('<p class="month_nav">' +
      '<span class="button prev" title="上个月">&#171;</span>' +
      ' <span class="month_name"></span> ' +
      '<span class="button next" title="下个月">&#187;</span>' +
      '</p>');
    ...
    var tableShell = "<table style='width: 17.5em'><thead><tr>";
  ...
  setPosition: function() {
    ...
    this.rootLayers.css({
	  //源代码下面两行都是打开的,如果打开下面两行,在弹出框上面使用会出现位置不对的情况
