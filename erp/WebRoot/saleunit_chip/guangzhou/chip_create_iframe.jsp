...
<script type="text/javascript" language="javascript">
	...
	$(document).ready(function(){
		...
		new MyContractCustomerDataGrid({
			...
			customerModuleId:"customerId", datagridModuleId:"customer_table", isChip:true
		});
	});	
...
<form action="./saleunit_chip_manager/guangzhou/addChip.action" method="post" id="chipFormId">
	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="gbox" style="font-size:12px; line-height:26px">	
			  ...
			  <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" style="empty-cells:show">
			   ...
			   <tr bgcolor="#E9F5FF" style="empty-cells:show">
                ...
                <td id="t14">
				&nbsp;<input type="text" id="chipNo" name="chip.chipNo"/>	
				<input type="hidden" name="chip.chipType" value="${chipType}" />
				</td>		
				
                <td id="t15" style="width:15%" align="right">认筹金额&nbsp;</td>
                <td id="t16" style="width:30%">
				&nbsp;<input type="text" style="width:60%" id="chipMoney" name="chip.chipMoney"/>
				</td>			
              </tr>	 
			   ...
			   <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
                ...
                <td id="t16" style="width:30%">				 
					...
					<input type="hidden" id="build_id1" name="chip.buildId1"/>
					<input type="hidden" id="area_id1" name="chip.areaId1"/>
			   ...
			   <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
                ...
                <td id="t16" style="width:30%">				 
					...
					<input type="hidden" id="build_id2" name="chip.buildId2"/>
					<input type="hidden" id="area_id2" name="chip.areaId2"/>
			   ...
			   <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
                ...
                <td id="t16" style="width:30%">				 
					...
					<input type="hidden" id="build_id3" name="chip.buildId3"/>
					<input type="hidden" id="area_id3" name="chip.areaId3"/>
