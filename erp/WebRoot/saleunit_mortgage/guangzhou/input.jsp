...
<%--主体导航页头 --%>
<div class="title01" ><a href="<%=basePath%>saleunit/mortgage/guangzhou/searchList.action" target="_self">查询抵押</a></div>
<div class="title02"><a href="<%=basePath%>saleunit/mortgage/guangzhou/forInput.action" target="_self">新建抵押</a></div>	
...
<%--主体table top --%>
	  ...
	  <form class="registerform" action="./demo/empty/inputDemo.action" method="post" >	
		 ...
		 <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="gbox" >		  		   
              <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
                ...
                <td id="t16" style="width:30%">
				 <input type="text" id="unitId" name="appoint.unitId" class="leftcreateinputbox01"/>
				 </td>
			   ...
			   <tr onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF"; align="center">
				<td colspan="4">
				  ...
				  <input type="hidden" id="baseUrl" value="<%=basePath%>"/>
					&nbsp;&nbsp;
				  <input type="button" value="  取消  " onClick="javascript:window.location.href = '<%=basePath%>saleunit/mortgage/guangzhou/searchList.action'" />
				</td>
			  </tr>			 
