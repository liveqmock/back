...
<%--主体导航页头 --%>
<div class="title02" ><a href="./saleunit/mortgage/guangzhou/searchList.action" target="_self">查询抵押</a></div>
<div class="title01"><a href="./saleunit/mortgage/guangzhou/forInput.action" target="_self">新建抵押</a></div>	
...
<%--主体table top --%>
  ...
  <tr class="gboxbg">
    ...
    <td width="197" align="center">抵押合同号</td>
    <td width="197" align="center">抵押日期</td>
    <td width="197" align="center">借款合同号</td>
    <td width="197" align="center">借款银行</td>
    <td width="197" align="center">借款金额</td>
    <td width="197" align="center">评估公司</td>   
	  ...
	  <tr onMouseOver="this.style.backgroundColor='#f1f9fe';" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF"
	   title='客户名称:<s:property value="#c.customerName"/>, 预约日期:<s:date name="#c.appointDate" format="yyyy-MM-dd "/>'> 
		...
		<td align="center" valign="middle" class="fontblue">
			<a href="./saleunit/mortgage/guangzhou/getById.action?id=<s:property value='#c.id'/>" target="_self" ><s:property value="#c.customerName"/></a>
		</td>
