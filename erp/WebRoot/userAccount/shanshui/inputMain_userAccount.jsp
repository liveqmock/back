      ...
      <div class="titlel"></div>
        <div class="titlebg" style=" height:auto;overflow:hidden;">
          ...
          <div class="title01" ><a  href="./user_shanshui!indexUserAccount.action" target="_self">列表</a></div>
            <div class="title02"><a  href="./user_shanshui!addUserAccountJsp.action" target="_self">新建</a></div>
        
          <div class="c"></div>
           <form action="./user_shanshui!addUserAccount.action" method="post" id="commentForm">
