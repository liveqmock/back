...
<table width="100%" border="0" cellspacing="0">
  <tr>
	...
	<s:include value="../../customer/shanshui/left.jsp"></s:include>
    ...
    <div class="right05">
      <div class="titlel"></div>
        <div class="titlebg" style=" height:auto;overflow:hidden;">
	        ...
	        <div class="title02" ><a href="./user_shanshui!indexUserAccount.action" target="_self">列表</a></div>
            <div class="title01"><a href="./user_shanshui!addUserAccountJsp.action" target="_self" >新建</a></div>
       ...
       <form action="./user_shanshui!indexUserAccount.action" method="get">
		  
            <tr>
              <td width="5%" height="0" valign="bottom"></td>
            ...
            <tr>
              <td width="124" height="0" align="left" nowrap>姓名：<input value="${userCond.userName}" name="userCond.userName" maxlength="10"/>
  ...
  <tr class="gboxbg">
	...
	<table width="100" height="28"  border="0" align="center" cellspacing="0">
      <tr>
        ...
        <td align="center" valign="middle"><table width="5" border="0" cellspacing="0">
          <tr>
            <td><a href="./user_shanshui!indexUserAccount.action?ob=31"><img src="images/blue/upn.gif" width="9" height="10" border="0" /></a></td>
          </tr>
          <tr>
            <td><a href="./user_shanshui!indexUserAccount.action?ob=32"><img src="images/blue/downopen.gif" width="9" height="10" border="0" /></a></td>
          </tr>
        </table>	</td>
      </tr>
    </table></td>
	...
	<table width="100" height="28"  border="0" align="center" cellspacing="0">
      <tr>
        ...
        <td align="center" valign="middle"><table width="5" border="0" cellspacing="0">
          <tr>
            <td><a href="./user_shanshui!indexUserAccount.action?ob=11"><img src="images/blue/upn.gif" width="9" height="10" border="0" /></a></td>
          </tr>
          <tr>
            <td><a href="./user_shanshui!indexUserAccount.action?ob=12"><img src="images/blue/downopen.gif" width="9" height="10" border="0" /></a></td>
          </tr>
        </table>	</td>
      </tr>
    </table></td>
  ...
  <s:iterator value="userAccountList" id="userlist">
	  <tr onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF";>
		...
		<td align="center" valign="middle"  class="fontblue">	
			<a
																		href="./user_shanshui!updateUserAccountJsp.action?id=${id}"
