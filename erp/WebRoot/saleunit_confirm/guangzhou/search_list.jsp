  ...
  <head>
	...
	<script type="text/javascript" language="javascript">
		...
		function getIdForUpdate(id){
			location.href = "./saleunit/confirm/guangzhou/getById.action?id=" + id;
		}
...
<%--主体导航页头 --%>
<div class="title02" ><a href="./saleunit/confirm/guangzhou/searchList.action" target="_self">查询认购</a></div>
<div class="title01"><a href="./saleunit/confirm/guangzhou/forInput.action" target="_self">新建认购</a></div>	
...
<%--主体table top --%>
     ...
     <form class="registerform" id="searchForm" action="<%=request.getContextPath() %>/saleunit/confirm/guangzhou/searchList.action" method="post" >
		  <tr>
		  	<td colspan="6">
  ...
  <tr class="gboxbg">
	...
	<td width="120" align="center">协议编号
	</td>
	...
	<table width="100" height="28"  border="0" align="center" cellspacing="0">
      <tr>
        <td width="80%" align="center" valign="middle">认购日期</td>
        <td align="center" valign="middle"><table width="5" border="0" cellspacing="0">
          <tr>
            <td><a href="./saleunit/confirm/guangzhou/searchOrderBy.action?ob=12"><img id="img12" src="images/blue/upn.gif" width="9" height="10" border="0" /></a></td>
          </tr>
          <tr>
            <td><a href="./saleunit/confirm/guangzhou/searchOrderBy.action?ob=11"><img id="img11" src="images/blue/downn.gif" width="9" height="10" border="0" /></a></td>
          </tr>
        </table>
	</td>
      </tr>
	...
	<td width="100" align="center" valign="middle">
	 ...
	 <td width="100" align="center">定单类型</td>
   ...
   <s:iterator value="#request.confirmList" id="c">  
	  <tr onMouseOver="this.style.backgroundColor='#f1f9fe';" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
	   title='客户名称:<s:property value="#c.customerName"/>, 认购日期:<s:date name="#c.signDate" format="yyyy-MM-dd "/>'> 
		...
		<td align="center" valign="middle" class="fontblue">
			<a href="./saleunit/confirm/guangzhou/getById.action?id=${c.id}" target="_self">${c.propertyUnitNo}</a>
		...
		<td align="center" valign="middle" class="fontblue">
			<a href="./saleunit/confirm/guangzhou/getById.action?id=${c.id}" target="_self">${c.agreeNo}</a>
		</td>
		<td align="center" valign="middle">
