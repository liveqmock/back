           ...
           <tr>
			...
			<tr>
			 ...
			 <tr>
			  ...
			  <input type="button" value="  添加权益人  " id="createPropertyOwner" onclick="inputPropertyOwnerDialog(${confirm.id})"/>
              </td>
            </tr>
   ...
   <s:iterator value="#request.ownerList" id="c">  
	  <tr onMouseOver="this.style.backgroundColor='#f1f9fe';" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF"> 
		...
		<td align="center" valign="middle" class="fontblue" title="点击修改">
			<a href="#" onclick="return updatePropertyOwnerDialog(${c.id})">${c.customerName}</a>
		</td>
