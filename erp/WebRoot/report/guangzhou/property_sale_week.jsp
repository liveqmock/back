...
<%--主体导航页头 --%>
<div class="title02" ><a href="./report/guangzhou/propertySaleWeek.action" target="_self">周报</a></div>
<div class="title01" ><a href="./report/guangzhou/propertySaleMonth.action" target="_self">月报</a></div>
<div class="title01" ><a href="./report/guangzhou/propertySaleYear.action" target="_self">年报</a></div>
...
<%--主体table top --%>
  ...
  <tr class="gboxbg">
    ...
    <td colspan="4" align="center">周成交统计(齐定)</td>
    <td  colspan="4" align="center">周签约统计</td>
    <td   colspan="2" align="center">周回款情况</td>
  </tr>
  <tr class="gboxbg">
