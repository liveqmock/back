...
<%--主体导航页头 --%>
<div class="title01" ><a href="./report/guangzhou/confirm.action" target="_self">公司认购单</a></div>
<div class="title02" ><a href="./report/guangzhou/confirmProperty.action" target="_self">楼盘认购单</a></div>
...
<%--主体table top --%>
     ...
     <form class="registerform" id="searchForm" action="<%=request.getContextPath() %>/report/guangzhou/confirmProperty.action" method="post" >
		  <tr>
		  	<td colspan="6">
