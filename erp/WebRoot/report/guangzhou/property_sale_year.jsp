...
<%--主体导航页头 --%>
<div class="title01" ><a href="./report/guangzhou/propertySaleWeek.action" target="_self">周报</a></div>
<div class="title01" ><a href="./report/guangzhou/propertySaleMonth.action" target="_self">月报</a></div>
<div class="title02" ><a href="./report/guangzhou/propertySaleYear.action" target="_self">年报</a></div>
<div class="title01" ><a href="./report/guangzhou/propertySaleSum.action" target="_self">累计成交</a></div>
...
<%--主体table top --%>
  ...
  <tr class="gboxbg">
    <td rowspan="2" width="150px" align="center">楼栋</td>
    <td colspan="4" align="center">年成交统计(齐定)</td>
    <td  colspan="4" align="center">年签约统计</td>
    <td   colspan="2" align="center">年回款情况</td>
  </tr>
  <tr class="gboxbg">
  ...
  <td width="150px" align="center">  
	<a class="ablue" style="color: #1199FF;" href="./report/guangzhou/propertyNum.action" target="_self">A15栋</a>
</td>
  ...
  <tr onMouseOver="this.style.backgroundColor='#f1f9fe';" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF">
  <td width="150px" align="center">
  <a class="ablue" style="color: #1199FF;" href="./report/guangzhou/propertyNum.action" target="_self">A16栋</a>
  </td>
  <td align="right">1000</td>
  <td align="right">1000</td>
  <td align="right">1000</td>
