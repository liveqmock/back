...
<%--主体导航页头 --%>
<div class="title01" ><a href="./report/guangzhou/appoint.action" target="_self">公司预约单</a></div>
<div class="title02" ><a href="./report/guangzhou/appointProperty.action" target="_self">楼盘预约单</a></div>
...
<%--主体table top --%>
     ...
     <form class="registerform" id="searchForm" action="<%=request.getContextPath() %>/report/guangzhou/appointProperty.action" method="post" >
		  <tr>
		  	<td colspan="6">
              ...
              <td colspan="6">			  
					  ...
					  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="gbox" >
						  <tr class="gboxbg">
						   ...
						   <s:iterator value="#request.propertyReportList" id="c">  
