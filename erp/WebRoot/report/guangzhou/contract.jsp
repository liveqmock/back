...
<%--主体导航页头 --%>
<div class="title02" ><a href="./report/guangzhou/contract.action" target="_self">公司合同单</a></div>
<div class="title01" ><a href="./report/guangzhou/contractProperty.action" target="_self">楼盘合同单</a></div>
...
<%--主体table top --%>
     ...
     <form class="registerform" id="searchForm" action="<%=request.getContextPath() %>/report/guangzhou/contract.action" method="post" >
		  <tr>
		  	<td colspan="6">
				 ...
				 <s:iterator value="#request.contractReportList" id="c">  
					...
					<tr onMouseOver="this.style.backgroundColor='#f1f9fe';" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF">
						<td width="197" align="center" valign="middle" class="fontblue">
							<a href="./report/guangzhou/contractProperty.action?cond.propertyId=${c.pId}&cond.date1=${cond.date1}&cond.date2=${cond.date2}" target="_self">${c.propertyName}</a>
						</td>
