		...
		<tr>
		 ...
		 <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="gbox" >
		 	...
		 	<tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
              ...
              <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
                ...
                <td id="t16" style="width:30%">				 
				 <s:select list="selPayType" name="detail.payType" id="payType"/>
             ...
             <tr onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF";>
                ...
                <td id="t12">
				 	<input type="text" id="payMoney" name="detail.payMoney" class="leftcreateinputbox01" style="width:50%"/>
					元
				</td>
				
				 <td id="t11"  align="right"><font color="#FF0000">*</font>支付方式&nbsp;</td>
                <td id="t12">	
					 <s:select list="selPayWay" name="detail.payWay" id="payWay"/>
				</td>
			  ...
			  <tr onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF";>
                ...
                <td id="t12">	
					 <s:select list="selBankWay" name="detail.bankWay" id="bankWay"/>
				</td>
