				...
				<tr style="height: 100%">
					...
					<DIV style="WIDTH: 98%; HEIGHT: 100%; BACKGROUND-COLOR: #A4C3D7;padding: 1px">
						...
						<table width="100%" class="mainbg20111112" style="height: 100%">
							...
							<form class="registerform" action="./sale_hengda/customer/update.action" method="post" >	 
											...
											<tr>
											 ...
											 <div class="c"></div>
											  <div class="c">
												...
												<s:select list="selCompany" name="customer.companyId" value="#session.c.companyId" />
												<label>
													<span>所属项目</span>
												</label>
												<s:select list="selProject" name="customer.projectId" value="#session.c.projectId" />
												 &nbsp;&nbsp;
		...
		<td colspan="6">
		 <input type="hidden" name="customer.id" value="<s:property value='#session.c.id'/>"/>
		  ...
		  />
			...
			&nbsp;&nbsp;
		  <input type="button" value="  取消  " onClick="javascript:window.location.href = './sale_hengda/customer/index.action'" />
		  &nbsp;&nbsp;
		  
		  <input type="button" value="  跟进  " id="follow" ac="sale_hengda/customer"
