...
<table width="100%" border="0" cellspacing="0">
    ...
    <div class="right05">
      <div class="titlel"></div>
       <div class="titlebg" style=" height:auto;overflow:hidden;">
	        ...
	        <div class="title02" ><a href="./sale_hengda!searchSaleFromType.action?type=month" target="_self">在售数据月查询</a></div>
       ...
       <form action="./sale_hengda!searchSaleFromType.action" method="get">
              ...
              <td height="0" colspan="2">
				...
				&nbsp;<a href="./sale_hengda!downLoadMonth.action">下载数据</a>
			  </td>  			 
   ...
   <tr >
	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="gbox" >
	  ...
	  <tr class="gboxbg">
		...
		<td align="center" valign="middle" colspan="9">本月数据</td>
  ...
  <tr class="gboxbg" align="center" style="white-space:nowrap">
   ...
   <s:iterator value="#request.saleMonthList" id="c">
