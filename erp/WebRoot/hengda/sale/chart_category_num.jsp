				...
				<tr style="height: 100%">
					...
					<DIV style="WIDTH: 98%; HEIGHT: 100%; BACKGROUND-COLOR: #A4C3D7;padding: 1px">
						...
						<table width="100%" class="mainbg20111112" style="height: 100%">
							<tr>
								...
								<td width="100%" valign="top" height="100%" style="overflow: hidden;">
									...
									<div class="titlebg" style="height: auto; overflow: hidden;">
										   ...
										   <div class="title02" ><a href="./sale_hengda/chart/categoryNum.action" target="_self">单项环比走势图</a></div>
						   ...
						   <form class="registerform" action="<%=request.getContextPath() %>/sale_hengda/chart/categoryNum.action" method="post" >
								  <tr>
								<td colspan="6">	
