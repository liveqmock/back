			...
			$(document).ready(function() {
				chart = new Highcharts.Chart({
					...
					plotOptions: {
				        ...
				        series: 
				       <s:property value="chartSeries"  escape="false"/>
							...
							<tr>
								...
								<td width="100%" valign="top" height="100%" style="overflow: hidden;">
									...
									<div class="titlebg" style="height: auto; overflow: hidden;">
										 ...
										 <div class="title02" ><a href="./sale_hengda/chart/project.action" target="_self">查看全国曲线</a></div>       
										...
										<table width="100%" border="0" align="left" cellspacing="0">
											...
											<!-- 搜索表单 top -->
											<form action="sale_hengda/chart/country.action" method="post">
	<table width="100%" border="0" align="left" cellspacing="0">
	<%-- 蓝色边条begin --%>	
		 <tr>
...
<%-- 列表 begin --%>		
     <tr>
		...
		<div class="gbox1" style="width: 92%;">	
