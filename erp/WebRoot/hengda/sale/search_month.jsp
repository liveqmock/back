...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script language="javascript" type="text/javascript">
			$().ready(function(){
				...
				$("#saleMonthCond_companyId").change(function(){
					companyToProject(this.value, "saleMonthCond_projectId");
				});
	...
	<body>
			...
			--%>
			  <div class="titlel"></div>
			   <div class="titlebg" style=" height:auto;overflow:hidden;">
					...
					<div class="title02" ><a href="./sale_hengda/search/month.action?from=left" target="_self">本月累计</a></div>
       ...
       <form action="./sale_hengda/search/month.action" method="get">
	   		<tr style="white-space: nowrap">
			<td height="0" align="left" colspan="6">
				<label>
					<span>日期</span>
				</label>								
			  	<input class="Wdate" type="text" id="date1" name="saleMonthCond.date1" style="width:90px" value="${saleMonthCond.date1}" onClick="WdatePicker()"/>
				-
			  	<input class="Wdate" type="text" id="date2" name="saleMonthCond.date2" style="width:90px" value="${saleMonthCond.date2}" onClick="WdatePicker()"/>
				<label>
					<span>所属公司</span>
				</label>
				<s:select list="selCompany" name="saleMonthCond.companyId" value="#session.companyId" />
				<label>
					<span>所属项目</span>
				</label>
				<s:select list="selProject" name="saleMonthCond.projectId" value="#session.projectId" />
				<input type="submit" value="  搜索  " id="searchSubmit" onClick="return check();"/>				
				<a href="./sale_hengda/search/downLoadMonth.action" class="ablue" >下载数据</a>
			  </td>  			 
   ...
   <s:iterator value="#request.saleTypeList" id="c">
	   <tr onMouseOver="this.style.backgroundColor='#ffffbf';" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF"> 
			...
			<td align="center" valign="middle">
				...
				saleCond.date1=${saleMonthCond.date1}&saleCond.date2=${saleMonthCond.date2}
