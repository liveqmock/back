				...
				>
					...
					<div class="leftbg"><%--
						...
						<%if(PermissionUtils.getUserFuncTreeList() != null){
							...
							<div class="leftl"></div>
							<div class="leftm">
								<a href="<%=t.getActionUrl() %>" target="_self"><%=t.getTreeName()%> </a>
							</div>
							<div class="leftr">
							</div>
							<div class="c"></div>	
						...
						<div class="leftlist">
							<div class="leftl"></div>
							<div class="leftm">
								<a href="./user_role_priv!rolePriv_index.action" target="_self">角色管理</a>
							</div>
							<div class="leftr">
							</div>
							<div class="c"></div>	
						...
						<div class="leftlist">
							<div class="leftl"></div>
							<div class="leftm">
								<a href="./user_role_priv!priv_index.action" target="_self">权限定义</a>
							</div>
							<div class="leftr">
							</div>
							<div class="c"></div>	
					...
					<div class="leftlist">
						...
						<div class="leftlist">
							<div class="leftl"></div>
							<div class="leftm"><a href="./cache!toCachePage.action" target="_self">系统设置</a></div>
							<div class="leftr"></div>
							<div class="c"></div>	
						</div>
