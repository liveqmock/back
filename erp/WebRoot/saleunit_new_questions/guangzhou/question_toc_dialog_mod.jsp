...
<body>
<form action="./saleunit_new_questions/appoint/guangzhou/questionTocModForm.action" id="question_toc_form" method="post">	
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="gbox" style="font-size:12px; line-height:20px">
		<tr bgcolor="#ffffff">
			...
			<td>
				<input name="newQuestionTopic.topicName" value="${newQuestionTopic.topicName}"/>
			</td>
		</tr>
		<tr bgcolor="#ffffff">
			<td width="100px">题目类别</td>
			<td >
				<input name="newQuestionTopic.topicGroup " value="${newQuestionTopic.topicGroup}"/>
			</td>
		</tr>
		<tr bgcolor="#ffffff">
			<td>答案类型</td>
			...
			<s:else>
				<td>
					<input type="radio" name="newQuestionTopic.topicType" value="1"/>单选
					<input type="radio" name="newQuestionTopic.topicType" value="2" checked="checked"/>多选
				</td>
			</s:else>
		</tr>
		<tr bgcolor="#ffffff">
			...
			<input type="hidden" name="newQuestionTopic.id" value="${qtid}"/>
			换行区分答案选项
			<textarea rows="" cols="" style="width: 90%;height: 80px;font-size: 12px" name="newQuestionTopic.topicContent">${newQuestionTopic.topicContent}</textarea>
			</td>
		</tr>
		<tr bgcolor="#ffffff">
