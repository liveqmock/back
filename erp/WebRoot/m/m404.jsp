...
<div data-role="page" id="exception_404_page">
	...
	<div data-role="content">
        ...
        <h3>
        <font color="#FF0000">出现异常,请联系开发人员</font>
		<br>
		该异常可能是因为录入字段值不合法造成的,请核查录入字段
        <br/>
         异常原因:<font color="#FF0000">${exception.message}</font>
        </h3>
