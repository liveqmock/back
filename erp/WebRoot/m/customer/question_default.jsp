...
<div data-role="page" id="input_default_question" data-ajax="false">

	<form id="input_default_question_form" action="<%=basePath%>m/addDefaultQuestion.action" method="post">
         ...
         <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" style="text-align:center">
            ...
            <tr>
                ...
                <td>                	
                   ...
                   <input type="text" name="customer.nationality" id="nationality" />
             ...
             <tr>
                ...
                <td>                	
                   <input type="text" name="customer.idcardNo" id="idcardNo" />
             ...
             <tr>
                ...
                <td>                	
                    <input type="text" name="customer.trafficDesc" id="trafficDesc" />
            ...
            <tr>
                ...
                <textarea data-mini="true" cols="40" rows="8" name="customer.address" id="address"></textarea>
            ...
            <tr>
                ...
                <td>                	
                    <input type="text" name="customer.postcode" id="postcode" />		                    
            ...
            <tr>
             ...
             <tr>
                ...
                <td>                	
                     <textarea data-mini="true" cols="40" rows="8" name="customer.notBuyReson" id="notBuyReson"></textarea>		
                </td>
            </tr>
             ...
             <tr>
                ...
                <td>                	
                   <textarea data-mini="true" cols="40" rows="8" name="customer.remark1" id="remark1"></textarea>			
                </td>
            </tr>
