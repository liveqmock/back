...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            bindCompanyPropertyPorjectForXKZX("projectName", "projectIds"); //单个项目的选择
            ...
            $('#tbList').datagrid({
                ...
                url:'',
                columns:[[
                    {field:'project_name',title:'项目名',width:100,sortable:true},
        ...
        function submitSearch() {
            ...
            $('#tbList').datagrid({
                ...
                loadMsg:'数据加载中...',
                url:'./saleunit_new_report/report/guangzhou/commission_affirm_prj.action',
                queryParams:{
        ...
        <table width="100%" border="0" align="left" cellspacing="0">
            ...
            <tr>
                ...
                <span style="margin: 0 0 0 12px">
					...
					<input type="hidden" id="projectIds" name="propertyUnitCond.strSearchProjectIds" value="" />
