...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<s:include value="../../header/header_autocomplete.jsp"></s:include>
			
		<script type="text/javascript">
		$(document).ready(function() {
            bindProjectDialogForSQKHOnlyQuestion("projectNames", "projectIds"); //单个项目的选择，并且设置该项目的问卷
			autoTextSalesman("saleName", "salesId");//销售人员的下拉选择	，需要引入header_autocomplete.jsp
		});			
								
		function download(){
			location.href = './saleunit_new_report/report/guangzhou/customerQuestionSalesDownload.action';	   
		}		
		...
		function queryForm(){
			...
			$("#dg").datagrid({
				url:"./saleunit_new_report/report/guangzhou/customerQuestionSalesAjax.action",
				queryParams:getInputsAsOjbect(["cond.strSearchCompanyProjectIds","cond.strSalesId","cond.date1","cond.date2","cond.sort","cond.order","questionId"])
			});
		}				
...
<body style="padding:0px;background:white;">
	    ...
	    <div id="toolbar" style="padding:5px;height:auto">
			...
			&nbsp;销售人员
                    ...
                    <input type="hidden" id="salesId" name="cond.strSalesId" />  
