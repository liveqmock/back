		 ...
		 <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="gbox" >		
              ...
              <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
                ...
                <td id="t16" style="width:30%" class="fontblue">				 
				 <a href="#" onclick="return false;" id="showContractCustomer">${customer.customerName}</a>
				 <input type='hidden' id='contractCustomerId' name="contract.customerId" value="${customer.id}"/>
				 
				 </td>
				<td id="t15" style="width:15%" align="right"><font color="#FF0000">*</font>联系电话&nbsp;</td>
                <td id="t16" style="width:30%">
			 	
				 <input type="text" id="phone" name="contract.phone" class="leftcreateinputbox01" value="${customer.phone}"/>
				</td>
              </tr>		
			  ...
			  <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
				...
				<td>
				  ${unit.unitNo}
				  <input type="hidden" id="hiddenUnitId" name="contract.unitId" value="${unit.id}"/>
				 </td>
			   ...
			   <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
                ...
                <td id="t16" style="width:30%">
					<input type="text" id="discountPercent" name="contract.discountPercent" class="leftcreateinputbox01"  style="width:25%"/>
				 </td>			
              </tr>	 
			   ...
			   <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
                ...
                <td id="t14">
				 <input type="text" id="buildPrice" name="contract.buildPrice" class="leftcreateinputbox01" style="width:25%"/>
				 元	
				</td>		
               <td id="t13" style="width:15%" align="right"><font color="#FF0000">*</font>套内成交单价&nbsp;</td>
                <td id="t14">
					 <input type="text" id="insideUnitPrice" name="contract.insideUnitPrice" class="leftcreateinputbox01"  style="width:25%"/>
				 元
				</td>		
              </tr>	 
			   ...
			   <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
                ...
                <td id="t16" style="width:30%">
					 <input type="text" id="sumMoney" name="contract.sumMoney" class="leftcreateinputbox01"  style="width:25%"/>
				 元</td>			
              </tr>	 
			  ...
			  <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
                ...
                <td id="t16" style="width:30%">				
				 <input type="text" id="renovateDesc" name="contract.renovateDesc" class="leftcreateinputbox01" value="${unit.renovateDesc}"/>
				</td>
                 <td id="t13" style="width:15%" align="right">装修单价&nbsp;</td>
                <td id="t14">
				 <input type="text" id="renovatePrice" name="contract.renovatePrice" class="leftcreateinputbox01" value="${unit.renovatePrice}" style="width:25%"/>
				元
				</td>				
              </tr>	
                ...
                <td id="t14">
				 <input type="text" id="renovateMoney" name="contract.renovateMoney" class="leftcreateinputbox01" value="${unit.renovateMoney}" style="width:25%"/>
				元
				</td>				
              </tr>	
			  ...
			  <tr  onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF" 
                ...
                <td id="t16" style="width:30%">
				   <input type="text" id="shouldDeposit" name="contract.shouldDeposit" class="leftcreateinputbox01" style="width:25%"/>
				 元						    </td>
			   ...
			   <tr onMouseOver="this.style.backgroundColor='#f1f9fe'" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF"; align="center">
				<td colspan="4">
				  ...
				  <input type="hidden" id="baseUrl" value="<%=basePath%>"/>
					&nbsp;&nbsp;
				  <input type="button" value="  取消  " onClick="javascript:window.location.href = '<%=basePath%>saleunit/contract/guangzhou/searchList.action'" />
				 </td>
			  </tr>		
