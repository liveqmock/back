...
<%--主体table top --%>
           ...
           <tr>
			...
			<tr>
			 ...
			 <tr>
			  ...
			  <input type="button" value="  添加权益人  " id="createPropertyOwner" onclick="inputPropertyOwnerDialogForContract(${contract.id})"/>
              </td>
            </tr>
  ...
  <tr class="gboxbg">
    ...
    <td width="120" align="center" valign="middle">客户姓名</td>   
	
    <td width="120" align="center">证件号码
	</td>
	
	<td width="120" align="center">联系电话
	</td>
	
     <td width="100" align="center" valign="middle">产权比例(%)
	</td>
	
	 <td width="100" align="center" valign="middle">代理人名称
	</td>
	
	<td width="100" align="center" valign="middle">代理人国籍
	</td>
	
	
	 <td width="100" align="center">代理人证件号码</td>
	
	 <td width="100" align="center">代理人联系电话</td>
  
  </tr>
 
 
  
   <s:iterator value="#request.ownerList" id="c">  
	  <tr onMouseOver="this.style.backgroundColor='#f1f9fe';" onMouseOut="this.style.backgroundColor=''" bgcolor="#FFFFFF"> 
		...
		<td align="center" valign="middle" class="fontblue" title="点击修改">
			<a href="#" onclick="return updatePropertyOwnerDialogForContract(${c.id})">${c.customerName}</a>
		</td>
