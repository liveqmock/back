              ...
              <td height="10" colspan="6">
                ...
                <tr>
                  <td bgcolor="#edf8fe">
					...
					<div class="d_out" onmouseover="this.className='d_over'" onmouseout="this.className='d_out'">
						<a href="./saleunit/contract/guangzhou/searchApprovalChange.action?contractId=${contract.id}">申请变更</a>
					</div>
					<div class="d_out" onmouseover="this.className='d_over'" onmouseout="this.className='d_out'">
			...
			<tr>
			 ...
			 <tr>
              <td height="10" colspan="6">
				  ...
				  <%--
				  <input type="button" value="新建附属房产" id="createAddProperty" onclick="createAddPropertyDialog(${contract.id})"/>
				  --%>
              </td>
            </tr>
