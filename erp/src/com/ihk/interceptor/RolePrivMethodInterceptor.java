 ...
 * 2012-9-27
 */
public class RolePrivMethodInterceptor extends BaseMethodInterceptor implements MethodInterceptor{
	...
	public Object invoke(MethodInvocation invocation) throws Throwable {
		...
		String cacheName = PermissionCacheName.ROLE_PRIV + methodName;
		...
		if(!isCheck(methodName)){
			...
			if(methodName.startsWith("find")){
				...
				CacheUtils.removeCacheByLikeCacheName(PermissionCacheName.ROLE_PRIV);
