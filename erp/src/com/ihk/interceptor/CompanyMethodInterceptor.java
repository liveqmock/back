 ...
 * 2012-9-27
 */
public class CompanyMethodInterceptor extends BaseMethodInterceptor implements MethodInterceptor{
	...
	public Object invoke(MethodInvocation invocation) throws Throwable {
		...
		String cacheName = PermissionCacheName.COMPANY + methodName;
		...
		if(!isCheck(methodName)){
			...
			if(methodName.startsWith("find")){
				...
				CacheUtils.removeCacheByLikeCacheName(PermissionCacheName.COMPANY);
