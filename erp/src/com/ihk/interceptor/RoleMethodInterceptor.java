 ...
 * 2012-9-27
 */
public class RoleMethodInterceptor extends BaseMethodInterceptor implements MethodInterceptor{
	...
	public Object invoke(MethodInvocation invocation) throws Throwable {
		...
		String cacheName = PermissionCacheName.ROLE + methodName;
		...
		if(!isCheck(methodName)){
			...
			if(methodName.startsWith("find")){
				...
				CacheUtils.removeCacheByLikeCacheName(PermissionCacheName.ROLE);
