...
//		}
	...
	public String downLoad() throws Exception{
		...
		try{
			...
			ReportUtils.downLoadReport(sb.toString(), fileName, response,EnumExportType.beforeSale.getValue());
	...
	public String downLoadContractCustomer() throws Exception{
		...
		try{
			...
			ReportUtils.downLoadReport(sb.toString(), fileName, response,EnumExportType.afterSale.getValue());
