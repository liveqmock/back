...
public class SetUserRoleByProjectAction extends SupperAction{
	...
	public String delUser(){
		this.leftUserCond = new UserAccountCond();
		this.leftUserCond.setProjectId("7");
...
//			return null;
//		}
//		if(selectRole.getId() == 0){
//			return null;
//		}
		if(rightUserCond == null)rightUserCond = new UserAccountCond();
//		this.leftUserCond.setRole(this.selectRole);
//		return iUserAccountServices.findHDUserByNoRole(this.rightUserCond);
		rightUserCond.setProId(Integer.parseInt(rightUserCond.getProjectId()));
		
		return iUserAccountServices.findUserAccountPage(this.rightUserCond);
	}
