...
//                if("0".equalsIgnoreCase(isSecondLinkage)){
                ...
                if(isRelation.equals("1")){
                    //关系户
                    checkFeeMap.put("commission","-");
                    checkFeeMap.put("commissionAmount","-");

                    checkFeeMap.put("rel_commission",commissionMap.get("rel_commission")==null?"0":commissionMap.get("rel_commission"));
